...
Berechnen wir das Modell `m1`; die Parameter stehen in @tbl-m1.


```{r m1, echo = TRUE}
#| label: tbl-m1
#| fig-cap: "Parameter für m1"
...
Berechnen wir die Vorhersagen für Dons neues Haus (mit den durch Mauern halbierten Zimmern), s. @tbl-m1-pred2.


```{r m1-estimate-pred, echo = TRUE}
#| fig-cap: "Vorhergesagter Hauspreis laut m1 für ein Haus mit 4 Zimmern"
#| label: tbl-m1-pred2
...
Das Kausalmodell `km1` ist in @fig-km1 dargestellt.
...
Dann spricht man von einer *Scheinkorrelation*.
:::
...
In ähnlicher Weise, s. @fig-coll2-dag.
...
eine Scheinkorrelation zwischen den Ursacxhen.
