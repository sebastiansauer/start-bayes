...
Erklären Sie kurz, was eine Post-Verteilung ist - insbesondere im Zusammenhang mit den Koeffizienten einer einfachen Regression - und wozu sie gut ist.
...
plots(plot_condition, p_post_at, n_rows = 2, tags = "A")
```
