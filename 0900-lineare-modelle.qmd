...
Wie man sieht, ist die Verteilung "zur Seite geschoben": 
Der Mittelwert liegt jetzt eben bei 0, s. @fig-d3-center.
...
$$
\begin{aligned}
\color{green}{\mu_i} & \color{green}= \color{green}{\beta_0 + \beta_1\cdot \text{weight}_i}  && \color{green}{\text{Lineares Modell} } \\
\end{aligned}
$$
