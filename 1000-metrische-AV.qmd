...
$$\text{kid score} = \text{intercept} + \beta_1 \cdot \text{mom hs} + \beta_2 \cdot \text{mom iq} + \beta_3 \cdot \text{mom hs} \cdot \text{mom iq}$$ {#eq-lm4}
...
$$\text{kid score} = -10 + 50\cdot \text{mom hs} + 1.1 \cdot \text{mom iq} + (-0.5) \cdot \text{mom hs} \cdot \text{mom iq}$$ {#eq-lm4-with-values}
...
1. [Anova-skalenniveau](https://sebastiansauer.github.io/Datenwerk/posts/anova-skalenniveau/anova-skalenniveau.html)
2. [Nullhyp-Beispiel](https://sebastiansauer.github.io/Datenwerk/posts/nullhyp-beispiel/nullhyp-beispiel)
1. [ttest-skalenniveau](https://sebastiansauer.github.io/Datenwerk/posts/ttest-skalenniveau/ttest-skalenniveau.html)
2. [Griech-Buchstaben-Inferenz](https://sebastiansauer.github.io/Datenwerk/posts/griech-buchstaben-inferenz/griech-buchstaben-inferenz)
3. [Interaktionseffekt1](https://sebastiansauer.github.io/Datenwerk/posts/interaktionseffekt1/interaktionseffekt1)
1. [Regression2](https://sebastiansauer.github.io/Datenwerk/posts/regression2/regression2)
2. [Regression3](https://sebastiansauer.github.io/Datenwerk/posts/regression3/regression3)
<!-- 3. [Regression6](https://sebastiansauer.github.io/Datenwerk/posts/regression6/regression6) -->
<!-- 1. [posterior_interval](https://sebastiansauer.github.io/Datenwerk/posts/posterior_interval/posterior_interval.html) -->
2. [diamonds-nullhyp-mws](https://sebastiansauer.github.io/Datenwerk/posts/diamonds-nullhyp-mws/diamonds-nullhyp-mws.html)
3. [stan_glm_parameterzahl](https://sebastiansauer.github.io/Datenwerk/posts/stan_glm_parameterzahl/stan_glm_parameterzahl.html)
1. [stan_glm_prioriwerte](https://sebastiansauer.github.io/Datenwerk/posts/stan_glm_prioriwerte/stan_glm_prioriwerte.html)
2. [zwert-berechnen](https://sebastiansauer.github.io/Datenwerk/posts/zwert-berechnen/zwert-berechnen.html)
3. [Regr-Bayes-interpret](https://sebastiansauer.github.io/Datenwerk/posts/regr-bayes-interpret/regr-bayes-interpret)
3. [Regr-Bayes-interpret03](https://sebastiansauer.github.io/Datenwerk/posts/regr-bayes-interpret03/regr-bayes-interpret03)
3. [Regr-Bayes-interpret02](https://sebastiansauer.github.io/Datenwerk/posts/regr-bayes-interpret03/regr-bayes-interpret02)
3. [rope4](https://sebastiansauer.github.io/Datenwerk/posts/rope4/rope4.html)
