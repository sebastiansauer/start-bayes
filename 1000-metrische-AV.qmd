...
\beta_0 &\sim \operatorname{Normal}(87, 51) && \text{Prior} \\
\beta_1 &\sim \operatorname{Normal}(0, 124) && \text{Prior} \\
\sigma &\sim \operatorname{Exp}(0.049) && \text{Prior}
\end{align*}$${#eq-m101} 
...
Stans Ausgabe kann man in Mathe-Sprech so darstellen, s. @eq-m1011.


$$
\begin{aligned}
\text{kidscore}  &\sim \mathcal{N}(0,2.5)\\
\mu_i &= \beta_0 + \beta_1\text{momiq}_i + \beta_2\text{momage}_i \\
