...
sieht die Forschungsfrage so aus (@eq-fofra1):


$$\mu_{x=1|M} \ne \mu_{x=0|M}$${#eq-fofra1}
...
ggplot(kidiq) +
  ...
  stat_summary(geom = "point", fun = mean, color = okabeito_colors()[1], size = 4) 
...
In diesem Abschnitt untersuchen wir ein Modell mit zwei z-standardisierten, metrischen Prädiktoren (und einer metrischen, nicht-standardisierten UV).
...
$$y= \beta_0 + \beta_1x_1 + \beta_2 x_2 + \cdots $${#eq-lm1} 
...
4. [datenwerk.netlify.app/posts/finde-prior/](https://datenwerk.netlify.app/posts/finde-prior/)
