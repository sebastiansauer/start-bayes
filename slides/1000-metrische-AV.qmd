...
# Taxonomie von Forschungsfragen {.center footer=false}
...
# Fallbeispiel 1: `y ~ b` {.center footer=false}
...
# Fallbeispiel 2: `y ~ x + b` {.center footer=false}
...
# Fallbeispiel 3: Interaktion {.center footer=false}
...
# Fallbeispiel 4: Zentrierung {.center footer=false}
...
# Fallbeispiel 5: `y ~ g` {.center footer=false}
...
# Vertiefung: Wechsel der Referenzkategorie {.center footer=false}
...
# Fallbeispiel 6: `y ~ x1 + x2` {.center footer=false}
...
# Fallbeispiel 7: Standardisierung {.center footer=false}
...
# `y_z ~ x1_z + x2_z` {.center footer=false}
