...
ANTWORT: [Dieser Tag](https://sebastiansauer.github.io/Datenwerk/#category=qm2-pruefung)  stellt Fragen einer Probeprüfung zusammen.
...
FRAGE: Welche Art von Fragen können wir erwarten? (z. B. Multiple Choice, offene Fragen oder mathematische Herleitungen)
...
FRAGE: Gibt es bestimmte Übungsaufgaben oder Materialien, die Sie empfehlen, um sich gezielt auf die Theorie-Klausur vorzubereiten?

ATNWORT: [Hier](https://sebastiansauer.github.io/Datenwerk/#category=qm2-pruefung) finden Sie eine Sammlung von Fragen, die in einer Probeprüfung gestellt wurden. Diese Fragen können Ihnen helfen, sich gezielt auf die Prüfung vorzubereiten.
