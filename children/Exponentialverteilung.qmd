...
LaTeX-Float (fuenf Tabs mit je einem vollen Plot). Fuer den Druck stattdessen
eine fig-subcap-Abbildung mit 2 Spalten (layout-ncol: 2) statt 3 -- bei mehr
als 2 Diagrammen pro Zeile werden die Einzelplots im Druck zu klein/
unleserlich. -->
...
#| label: tbl-exp
#| echo: false
#| tbl-cap: "Median-Werte von Exponentialverteilungen mit verschiedenen Werten für λ (lambda). p50: 50%-Quantil (Median), p95: 95%-Quantil (Dieser Wert wird mit 95% Wahrscheinlichkeit nicht überschritten; er bietet sich als *Obere Grenze* der plausiblen Werte an.)"
d_exp <- 
  tibble(
