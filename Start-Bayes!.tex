...
\item
  Bei Aufgaben zur ``Bayes-Box'' (Erstellung einer Gitterwert-Tabelle)
  ...
  \item
    ...
    etwa Anteile), so ist der ganze Wertebereich zu modellieren. Es sind
    100 verschiedene Parameterwerte zu berechnen.
  \item
    Handelt es sich um Parameter \(X\) mit einem unbegrenzten
    Wertebereich (wie normalverteilte Variablen), so ist der
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, opacitybacktitle=0.6, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hinweis}, colframe=quarto-callout-note-color-frame, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, titlerule=0mm, arc=.35mm, toptitle=1mm, leftrule=.75mm, breakable, bottomtitle=1mm, coltitle=black, rightrule=.15mm, bottomrule=.15mm, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, opacitybacktitle=0.6, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Wichtig}, colframe=quarto-callout-important-color-frame, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white, colback=white, titlerule=0mm, arc=.35mm, toptitle=1mm, leftrule=.75mm, breakable, bottomtitle=1mm, coltitle=black, rightrule=.15mm, bottomrule=.15mm, left=2mm]
...
\begin{verbatim}
##   [1] 0.44 0.44 0.67 0.78 0.67 0.67 0.67 0.89 0.67 0.67 0.67 0.78 0.67 0.78 0.44
##  [16] 0.56 0.67 0.78 0.89 0.56 0.44 0.56 0.56 0.56 0.78 0.78 0.67 0.78 0.67 0.56
##  [31] 0.67 0.56 0.56 0.56 0.56 0.67 0.67 0.56 0.33 0.56 0.56 0.78 0.78 0.56 0.56
##  [46] 0.78 0.78 0.56 0.56 0.89 0.67 0.56 0.56 0.67 0.67 0.67 0.89 0.33 0.78 0.67
##  [61] 0.67 0.89 0.56 0.44 0.89 0.44 0.67 0.67 0.67 0.56 0.67 0.67 0.67 0.78 0.56
##  [76] 0.89 0.89 0.67 0.89 0.56 0.33 0.78 0.67 0.56 0.78 0.78 0.56 0.67 0.44 0.78
##  [91] 0.44 0.33 0.56 0.89 0.44 0.56 0.44 0.67 0.78 0.56
\end{verbatim}
...
\DocumentationTok{\#\#   \textless{}lgl\textgreater{}          \textless{}int\textgreater{}}
\DocumentationTok{\#\# 1 FALSE           8352}
\DocumentationTok{\#\# 2 TRUE            1648}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#   \textless{}lgl\textgreater{}                          \textless{}int\textgreater{}}
\DocumentationTok{\#\# 1 FALSE                           4577}
\DocumentationTok{\#\# 2 TRUE                            5423}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# 1  0.458    45.8}
\DocumentationTok{\#\# 2  0.542    54.2}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#            \textless{}dbl\textgreater{}            \textless{}dbl\textgreater{}}
\DocumentationTok{\#\# 1          0.637            0.667}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# 1 0.140 0.222 0.165}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#   \textless{}lgl\textgreater{}                       \textless{}int\textgreater{} \textless{}dbl\textgreater{}}
\DocumentationTok{\#\# 1 FALSE                        3160 0.316}
\DocumentationTok{\#\# 2 TRUE                         6840 0.684}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  5  0.333}
\DocumentationTok{\#\#  6  0.667}
\DocumentationTok{\#\#  7  0.556}
\DocumentationTok{\#\#  8  0.556}
...
\DocumentationTok{\#\# 4     6}
\DocumentationTok{\#\# 5     4}
\DocumentationTok{\#\# 6     4}
\end{Highlighting}
\end{Shaded}
...
\midrule()
\endhead
(Intercept) & 154.59 & (153.77, 155.40) & 100\% & 1.002 & 2347.00 &
Normal (154.60 +- 19.36) \\
\bottomrule()
\end{longtable}

Das Wesentliche: Unser Golem schätzt den Größenmittelwert der Kung auf
ca. 155cm bzw. auf einen Bereich von etwa 153.7744417 bis 155.4028244
schätzt.
...
\DocumentationTok{\#\#           \textless{}dbl\textgreater{} \textless{}dbl\textgreater{}}
\DocumentationTok{\#\# 1          155.  7.60}
\DocumentationTok{\#\# 2          154.  7.93}
\DocumentationTok{\#\# 3          155.  7.71}
\DocumentationTok{\#\# 4          155.  7.87}
\DocumentationTok{\#\# 5          154.  7.52}
\DocumentationTok{\#\# 6          155.  7.98}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#   \textless{}lgl\textgreater{}      \textless{}int\textgreater{} \textless{}dbl\textgreater{}}
\DocumentationTok{\#\# 1 FALSE       3348 0.837}
\DocumentationTok{\#\# 2 TRUE         652 0.163}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# mu        | [153.77, 155.40]}
\DocumentationTok{\#\# sigma     | [  7.20,   8.35]}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# (Intercept) | 154.59 | [153.77, 155.40] | 100\% | 1.002 | 2347.00 | Normal (154.60 +{-} 19.36)}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# Parameter   | Median |           95\% CI |   pd |  Rhat |     ESS |              Prior}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# (Intercept) | 154.62 | [153.82, 155.40] | 100\% | 1.002 | 2899.00 | Normal (178 +{-} 20)}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#   \textless{}lgl\textgreater{}          \textless{}int\textgreater{} \textless{}dbl\textgreater{}}
\DocumentationTok{\#\# 1 FALSE           8288 0.829}
\DocumentationTok{\#\# 2 TRUE            1712 0.171}
\end{Highlighting}
\end{Shaded}
...
\textbf{?@fig-m43a-nochmal} visualisiert die Ungewissheit von
Vorhersagen laut der PPV. Die Ungewissheit in
\textbf{?@fig-m43a-nochmal} ist die Antwort auf die Frage: ``Wie sicher
sind wir uns, zur Größe einer !Kung-Person, gegeben dass die z.B. 10 kg
mehr als der Durchschnitt wiegt?'' Eine Vorhersage bezeichnet man auch
als ``bedingte Verteilung'', da man den Wert einer Verteilung
voraussagt, \emph{gegeben} einer Bedingung, z.B.
\texttt{weight\_c\ =\ 10}.

\begin{figure}

{\centering \includegraphics{./lineare-modelle_files/figure-pdf/m43a-nochmal-1.pdf}

}

\caption{Visualisierung der Ungewissheit der Vorhersagen laut PPV: Die
Vorhersage von Beobachtungen beinhaltet mehr Ungewissheit als die
Vorhersage von zu erwartenden Werten, daher sind die
Ungewissheitsintervalle der PPV größer als die der Post-Verteilung.}
...
Abbildung~\ref{fig-m103}.\footnote{Alternativ kann man die gleiche
  Visualisierung - einfacher - so bekommen:
  \texttt{plot(estimate\_expectation(m10.3))}. Allerdings müssen Sie
  dann, bevor Sie m10.3 berechnen, \texttt{mom\_hs} als Faktorvariable
  definiernen mit \texttt{mutate} und \texttt{as.factor(mom\_hs)}.}
...
\NormalTok{kidiq }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{scale\_x\_continuous}\NormalTok{(}\AttributeTok{limits =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{140}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
als auch mütterlichem Schulabschluss. Es ist gut zu erkennen, dass der
Achsenabschnitt für die Daten nicht interpretierbar ist.}
...
\caption{\label{tbl-m10a}\textbf{?(caption)}}\begin{minipage}[t]{\linewidth}
\subcaption{\label{tbl-m10a-1}Fixed effects}
...
\caption{Parameter von m10.5 und HDIs }\tabularnewline
\toprule()
\begin{minipage}[b]{\linewidth}\raggedright
Parameter
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# (Intercept)      | [ 4997.63,  5158.67]}
\DocumentationTok{\#\# speciesAdelie    | [{-}1488.66, {-}1265.99]}
\DocumentationTok{\#\# speciesChinstrap | [{-}1493.22, {-}1209.76]}
\end{Highlighting}
\end{Shaded}
...
ausgeben lassen, s. \textbf{?@fig-m106-r2}.
...
{\centering \includegraphics{./metrische-AV_files/figure-pdf/fig-ma106-r2-1.pdf}

}

\caption{\label{fig-ma106-r2}Die Verteilung von R-Quadrat im Modell
m10.6}
...
\DocumentationTok{\#\#  26.0488892   0.6079276}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  70.9233115   0.6981756}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  17.3745476   0.6033778   0.4000252}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}0.0005549683  0.4429427610  0.0515174278}
\end{Highlighting}
\end{Shaded}
...
\midrule()
\endhead
(Intercept) & -5.55e-04 & (-0.09, 0.09) & 50.60\% & 0.999 & 4258.00 &
Normal (-2.81e-16 +- 2.50) \\
mom\_iq\_z & 0.44 & (0.36, 0.53) & 100\% & 1.000 & 4442.00 & Normal
(0.00 +- 2.50) \\
mom\_age\_z & 0.05 & (-0.03, 0.14) & 88.22\% & 1.000 & 4098.00 & Normal
(0.00 +- 2.50) \\
\bottomrule()
\end{longtable}
...
\DocumentationTok{\#\# 0.0003994279 0.4484011223}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# Parameter   |              95\% HDI}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# (Intercept) | [43046.19, 76142.49]}
\DocumentationTok{\#\# bedrooms    | [43203.16, 53342.88]}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# 2.00     |  1.57e+05 | 90652.57 | [{-}21114.57, 3.31e+05]}
\DocumentationTok{\#\# }
...
\DocumentationTok{\#\# bedrooms | Predicted |       SE |               95\% CI}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# 4.00     |  2.52e+05 | 90297.65 | [78990.76, 4.26e+05]}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Variable predicted: price}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# bedrooms | Predicted |      SE |               95\% CI}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# 4.00     |  2.53e+05 | 3076.64 | [2.47e+05, 2.59e+05]}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Variable predicted: price}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# Parameter   |               95\% HDI}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# (Intercept) | [ 23256.01, 49110.00]}
\DocumentationTok{\#\# bedrooms    | [{-}19319.04, {-}9025.80]}
\DocumentationTok{\#\# livingArea  | [   118.16,   132.05]}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# 4.00     |    1200.00 |  1.32e+05 | 70171.37 | [{-}3818.20, 2.66e+05]}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Variable predicted: price}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# 4.00     | 2.00e+05 | [1.94e+05, 2.05e+05]}
\DocumentationTok{\#\# 5.00     | 1.86e+05 | [1.75e+05, 1.96e+05]}
\DocumentationTok{\#\# 6.00     | 1.71e+05 | [1.56e+05, 1.86e+05]}
...
\DocumentationTok{\#\#           \textless{}dbl\textgreater{}   \textless{}dbl\textgreater{} \textless{}dbl\textgreater{}}
\DocumentationTok{\#\# 1          28.1 {-}0.0573  4.01}
\DocumentationTok{\#\# 2          30.0 {-}0.0639  3.57}
\DocumentationTok{\#\# 3          29.5 {-}0.0639  4.82}
\DocumentationTok{\#\# 4          30.9 {-}0.0726  3.08}
\DocumentationTok{\#\# 5          29.4 {-}0.0639  4.93}
\DocumentationTok{\#\# 6          30.7 {-}0.0688  3.14}
\end{Highlighting}
\end{Shaded}
...
##   <chr>             <dbl>
## 1 Mazda RX4          24.4
## 2 Mazda RX4 Wag      25.1
## 3 Datsun 710         13.9
## 4 Hornet 4 Drive     21.5
## 5 Hornet Sportabout  11.6
\end{verbatim}
...
\midrule()
\endhead
(Intercept) & 24.64 & (18.87, 30.31) & 100\% & 1.002 & 1569.00 & Normal
(20.09 +- 15.07) \\
hp & -0.04 & (-0.07, -0.01) & 99.62\% & 1.001 & 1376.00 & Normal (0.00
+- 0.22) \\
vs & 14.06 & (5.07, 23.17) & 99.85\% & 1.001 & 1353.00 & Normal (0.00 +-
29.89) \\
hp:vs & -0.11 & (-0.20, -0.03) & 99.55\% & 1.001 & 1565.00 & Normal
(0.00 +- 0.31) \\
\bottomrule()
\end{longtable}
