...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[borderline west={3pt}{0pt}{shadecolor}, breakable, interior hidden, boxrule=0pt, frame hidden, sharp corners, enhanced]}{\end{tcolorbox}}\fi
...
Dieses Dokument wurde erzeugt am/um 2023-01-05 18:36:02.
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, arc=.35mm, colback=white, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, left=2mm, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, toprule=.15mm, bottomtitle=1mm, bottomrule=.15mm, leftrule=.75mm, breakable, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hinweis}, opacityback=0, rightrule=.15mm]
...
\begin{tcolorbox}[enhanced jigsaw, titlerule=0mm, arc=.35mm, colback=white, colbacktitle=quarto-callout-important-color!10!white, coltitle=black, left=2mm, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-important-color-frame, toprule=.15mm, bottomtitle=1mm, bottomrule=.15mm, leftrule=.75mm, breakable, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Wichtig}, opacityback=0, rightrule=.15mm]
...
Abb. \textbf{?@fig-bin-klein} zeigt die Binomialverteilung
\(X \sim Bin(9, 1/2)\).

\includegraphics{./img/fig-bin-klein.png}\{\#fig-bin-klein=70\%\}
...
\midrule()
\endhead
(Intercept) & {[} 4995.80, 5155.86{]} \\
speciesAdelie & {[}-1486.01, -1263.58{]} \\
speciesChinstrap & {[}-1478.43, -1202.14{]} \\
\bottomrule()
\end{longtable}
...
\DocumentationTok{\#\#  25.8778786   0.6097106}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  71.0036810   0.6902323}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  17.4003351   0.6015811   0.4002056}
\end{Highlighting}
\end{Shaded}
...
\midrule()
\endhead
65 & 1 & 121.11753 & 27 & -1.0679324 & 0.521631 & 1.4078352 &
1.5602285 \\
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0579}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0826}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0661}}
...
\midrule()
\endhead
65 & 1 & 121.11753 & 27 & -1.067932374 & 0.521631 & 1.407835240 &
...
\begin{longtable}[]{@{}
  ...
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0877}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0965}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0965}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0965}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0965}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1140}}@{}}
...
\DocumentationTok{\#\# {-}0.0000406543  0.4423072930  0.0518368826}
\end{Highlighting}
\end{Shaded}
...
\midrule()
\endhead
(Intercept) & -4.07e-05 & (-0.08, 0.09) & 50.02\% & 1.000 & 4662.00 &
Normal (-2.81e-16 +- 2.50) \\
mom\_iq\_z & 0.44 & (0.36, 0.53) & 100\% & 1.000 & 4183.00 & Normal
(0.00 +- 2.50) \\
mom\_age\_z & 0.05 & (-0.03, 0.13) & 89.10\% & 1.000 & 4850.00 & Normal
(0.00 +- 2.50) \\
\bottomrule()
\end{longtable}
...
\DocumentationTok{\#\# \# Bayesian R2 with Compatibility Interval}
\DocumentationTok{\#\# }
\DocumentationTok{\#\#   Conditional R2: 0.204 (95\% CI [0.144, 0.269])}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}0.0006884366  0.4478655864}
\end{Highlighting}
\end{Shaded}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1154}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0962}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0481}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0865}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0865}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0865}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0865}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0288}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.1923}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 20\tabcolsep) * \real{0.0577}}@{}}
\toprule()
\begin{minipage}[b]{\linewidth}\raggedright
Parameter1
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\CommentTok{\#| fig{-}cap: "Bereinigte Regressionskoeffizienten"}
\CommentTok{\#| label: fig{-}bereinigt}
\FunctionTok{plots}\NormalTok{(m10}\FloatTok{.10}\NormalTok{a\_plot, m10}\FloatTok{.10}\NormalTok{b\_plot, m10}\FloatTok{.10}\NormalTok{c\_plot, m10}\FloatTok{.10}\NormalTok{d\_plot, }
      ...
      \AttributeTok{caption =} \StringTok{"Die vertikalen Balken zeigen die Residuen."}\NormalTok{,}
...
\textbf{?@fig-bereinigt} zeigt in der oberen Reihe die Regression eines
Prädiktors auf den anderen Prädiktor. Untere Reihe: Regression der
...
\midrule()
\endhead
2.00 & 1.58e+05 & 88955.82 & (-19831.84, 3.25e+05) \\
\bottomrule()
\end{longtable}
...
\midrule()
\endhead
4.00 & 2.52e+05 & 88703.39 & (73564.32, 4.27e+05) \\
\bottomrule()
\end{longtable}
...
\midrule()
\endhead
2 & 1200 & 158727.2 & 69127.62 & 32855.55 & 296678.4 \\
\bottomrule()
\end{longtable}
...
Tabelle~\ref{tbl-m2-preds} und sind in Abbildung~\ref{fig-m2-preds}
visualisiert.
...
\hypertarget{tbl-m2-preds}{}
\begin{longtable}[]{@{}rrrr@{}}
\caption{\label{tbl-m2-preds}Vorhersagen des Preises von Häusern mit
verschiedener Zimmerzahl gemittelt über die verschiedenen Werte der
Wohnfläche; basierend auf m2.}\tabularnewline
\toprule()
