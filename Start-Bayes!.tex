...
Aussage (``Frauen parken schneller\ldots{}'') sind. Zum Beispiel könnten
wir uns zu 99\% oder zu 51\% sicher sein - und \emph{wie sicher} wir uns
sind, macht schon einen Unterschied. Wenn Sie nächste Woche ei Fahri für
Ihren neuen Rolls Royce anheuern, müssen Sie ja wissen, ob es besser
eine Frau oder ein Mann sein soll.
...
``laut meiner Analyse sollten wir unser Werk in Ansbach/Peking/Timbuktu
bauen''. Sind Sie sich zu 50\%, 90\% oder 99,9\% sicher, dass Ihre
Aussage richtig ist? Wichtige Frage im echten Leben.
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hinweis}, coltitle=black, colback=white, toprule=.15mm, toptitle=1mm, bottomrule=.15mm, opacityback=0, titlerule=0mm, breakable, bottomtitle=1mm, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, leftrule=.75mm, left=2mm, arc=.35mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6]
...
Dieses Dokument wurde erzeugt am/um 2023-01-18 18:02:32.
...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Wichtig}, coltitle=black, colback=white, toprule=.15mm, toptitle=1mm, bottomrule=.15mm, opacityback=0, titlerule=0mm, breakable, bottomtitle=1mm, colbacktitle=quarto-callout-important-color!10!white, rightrule=.15mm, leftrule=.75mm, left=2mm, arc=.35mm, colframe=quarto-callout-important-color-frame, opacitybacktitle=0.6]
...
\item
  ...
  nicht lösbaren Aufgabe liegt der Fehler beim Prüfer.
\item
...
\leavevmode\vadjust pre{\hypertarget{def-inferenz}{}}%
\begin{definition}[Inferent]\label{def-inferenz}
...
\leavevmode\vadjust pre{\hypertarget{def-zufall}{}}%
\begin{definition}[Zufälliges Ereignis]\label{def-zufall}
...
\leavevmode\vadjust pre{\hypertarget{def-punktschaetzer}{}}%
\begin{definition}[Punktschätzer]\label{def-punktschaetzer}

Gibt man nur einen Punktwert an, wie 42\%, als Ergebnis einer Inferenz,
spricht man von einem \emph{Punktschätzer}.

Punktschätzer beinhalten \emph{keine Angabe} der Schätz(un)genauigkeit,
s. Abb. \textbf{?@fig-punktschaetzer2}, links. Rot markiert: Die
...
{\centering \includegraphics{./img/fig-punktschaetzer.png}

}

\caption{Eine Punktschätzung und ihre Ungewissheit}

\end{figure}

In Abb. \textbf{?@fig-punktschaetzer2}, rechts, ist die Ungewissheit in
den Regressionskoeffizienten visualisiert: Wie sicher sind wir uns zur
Stärke des Zusammenhangs von X und Y, vgl.
Definition~\ref{def-punktschaetzer}.
...
{\centering \includegraphics{./img/fig-predintervall.png}

}

\caption{Das Vorhersageintevall zeigt eine Punktschätzung und ihre
Ungewissheit}
...
\leavevmode\vadjust pre{\hypertarget{def-konfintervall}{}}%
\begin{definition}[Konfidenzintervall]\label{def-konfintervall}

Ein Konfidenzintervall (confidence intervall, CI) ist ein Oberbegriff
für Schätzbereiche. Die Grenzen eines Konfindenzintervall markieren
einen Bereich plausibler Werte für einen Parameter.
...
sich von 40 bis 44 Prozent erstreckt. Dieser Befund lässt sich so
...
\href{https://imgflip.com/i/77wn7m}{Kontinuierliches Lernen} ist der
...
Normalverteilungen können sich unterscheiden Mittelwert \(\mu\) und
ihrer Streuung, \(\sigma\). Diese beiden Größen (``Parameter'')
...
Ein Parameter (einer Verteilung) legt die ``Varianten'' einer Verteilung
fest. Durch die Wahl der Parameterwerte nimmt eine Verteilung eine
genaue Form an.
...
\hypertarget{der-globusversuch-als-modell-fuxfcr-zweiwertige-zufallsversuche}{%
...
Praxis, zumindest nicht auf dem ersten Blick. Er hat aber aber den
Vorteil, dass es ein einfaches, gut greifbares Beispiel ist, und damit
zum Lernen gut geeignet ist. Bei näherer Betrachtung ist der
Globusversuch prototypisch für ganz viele Fragestellungen:

\begin{itemize}
\tightlist
\item
  Von einem neuen Produkt von von \(n\) Exemplaren \(k\) verkauft. Auf
  welchen Wert \(p\) kann die Akzeptanzrate dieses Produkts geschätzt
  werden?
\item
  Ein Chat-Bot hat von \(n\) Fragen \(k\) richtig beantwortet. Wie hoch
  kann die Verständnisrate \(p\) dieses Programms geschätzt werden?
\item
  Eine neue Krebstherapie hat von \(n\) ``austherapierten'' Patientis
  \(k\) geheilt. Auf wie hoch kann die Erfolgsrate dieser Therapie
  geschätzt werden?
\end{itemize}
...
\begin{verbatim}
##   [1] 0.44 0.44 0.78 0.78 0.67 0.44 0.78 0.56 0.67 0.56 0.44 0.67 0.56 0.56 0.44
##  [16] 0.56 0.67 0.89 0.78 0.78 0.67 0.56 0.56 0.67 0.44 0.56 0.56 0.78 0.56 0.78
##  [31] 0.56 0.44 0.78 0.56 0.78 0.56 0.67 0.44 0.56 0.78 0.56 0.56 0.67 0.33 0.67
##  [46] 0.67 0.78 0.89 0.56 0.89 0.56 0.44 0.67 0.56 0.44 0.67 0.89 0.56 0.56 0.78
##  [61] 0.56 0.56 0.56 0.67 0.78 0.78 0.44 0.56 0.78 0.67 0.56 0.56 0.56 0.78 0.56
##  [76] 0.56 0.44 0.56 0.67 0.56 0.67 0.56 0.44 0.44 0.56 0.89 0.78 0.56 0.78 0.33
##  [91] 0.89 0.67 0.56 0.56 0.56 0.56 0.67 0.67 0.56 0.78
\end{verbatim}
...
\leavevmode\vadjust pre{\hypertarget{def-eti}{}}%
\begin{definition}[Perzentilintervall (PI)]\label{def-eti}

Intervalle (Bereiche), die die ``abzuschneidende''
Wahrscheinlichkeitsmasse hälftig auf die beiden Ränder aufteilen, nennen
wir \emph{Perzentilintervalle} oder (synonym)
\emph{Equal-Tails-Intervalle} (ETI), s. Abb. Abbildung~\ref{fig-eti},
rechtes Teildiagramm.
...
\subsection{Perzentil-Intervall}\label{perzentil-intervall}}
...
\hypertarget{intervalle-huxf6chster-dichte}{%
\subsection{Intervalle höchster
Dichte}\label{intervalle-huxf6chster-dichte}}

\leavevmode\vadjust pre{\hypertarget{def-hdi}{}}%
\begin{definition}[]\label{def-hdi}
...
Parameter enthält (in Bezug auf ein gegebenes Modell).
...
gleiche Wahrscheinlichkeitsmasse. Bei PI ist die
Wahrscheinlichkeitsmasse in diesen Rändern hingegen gleich groß.
...
\begin{longtable}[]{@{}lrr@{}}
\toprule()
gewinnchance\_muenze \textgreater{} 0.45 \& gewinnchance\_muenze
\textless{} 0.55 & n & prop \\
\midrule()
\endhead
FALSE & 9497 & 0.9497 \\
...
\begin{longtable}[]{@{}lrr@{}}
\toprule()
gewinnchance\_muenze \textgreater{} 0.7 & n & prop \\
\midrule()
\endhead
FALSE & 3123 & 0.3123 \\
TRUE & 6877 & 0.6877 \\
...
\begin{example}[Magnus Lagrande braucht die PPV]\label{exm-wozu-ppv}
...
Wer Näheres wissen will, findet
\href{https://easystats.github.io/easystats/}{hier} einen Anfang.
Außerdem sei an McElreath (2020) und Gelman, Hill, und Vehtari (2021)
verwiesen.
...
\midrule()
\endhead
(Intercept) & 154.62 & (153.83, 155.42) & 100\% & 1.000 & 2482.00 &
Normal (178 +- 20) \\
\bottomrule()
\end{longtable}
...
\leavevmode\vadjust pre{\hypertarget{def-pd}{}}%
\begin{definition}[Effektwahrscheinlichkeit]\label{def-pd}
...
der Frequentistischen Statistik (Makowski u.~a. 2019).
...
\textbf{?@tbl-m105} zeigt die Punktschätzer der Parameter für m10.5
...
(0.00 +- 3.40) \\
mom\_hs:mom\_iq\_c & -0.48 & (-0.78, -0.16) & 99.78\% & 1.002 & 1992.00
& Normal (0.00 +- 3.87) \\
\bottomrule()
\end{longtable}
...
\midrule()
\endhead
(Intercept) & {[} 4995.77, 5153.80{]} \\
speciesAdelie & {[}-1478.94, -1261.08{]} \\
speciesChinstrap & {[}-1491.10, -1213.90{]} \\
\bottomrule()
\end{longtable}
...
\DocumentationTok{\#\#  26.0534767   0.6079937}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  71.1031593   0.6873915}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  17.6411271   0.6030340   0.3933904}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}0.0008345111  0.4430345271  0.0514547315}
\end{Highlighting}
\end{Shaded}
...
\midrule()
\endhead
(Intercept) & -8.35e-04 & (-0.08, 0.08) & 50.62\% & 0.999 & 4956.00 &
Normal (-2.81e-16 +- 2.50) \\
mom\_iq\_z & 0.44 & (0.36, 0.53) & 100\% & 1.000 & 4476.00 & Normal
(0.00 +- 2.50) \\
mom\_age\_z & 0.05 & (-0.04, 0.14) & 87.30\% & 1.000 & 4752.00 & Normal
(0.00 +- 2.50) \\
\bottomrule()
\end{longtable}
...
\DocumentationTok{\#\# \# Bayesian R2 with Compatibility Interval}
\DocumentationTok{\#\# }
\DocumentationTok{\#\#   Conditional R2: 0.203 (95\% CI [0.142, 0.269])}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# 0.0007807571 0.4481311951}
\end{Highlighting}
\end{Shaded}
