...
"Mindestens eines der Ereignisse A und " schreibt man $A \cup B$ und sagt "A vereinigt B" oder "A oder B".
...
@eq-bed-wskt-box versinnbildlicht die Berechnung von $Pr(A|B)$ als Bruch.



$$\frac{\boxed{\begin{array}{c}\phantom{mm}\\\phantom{mm}\end{array}}}{\boxed{\begin{array}{c}\phantom{mmmm}\\\phantom{mmmm}\end{array}}}$${#eq-bed-wskt-box}
