...
Benötigt wird auch der Begriff der [Normalverteilung](https://statistik1.netlify.app/040-verbildlichen#normalverteilung) sowie der Begriff der [Quantile](https://statistik1.netlify.app/050-zusammenfassen.html#quantile).
...
da der Bereich $[-0.5, +0.5]$ die Hälfte (50%) der Wahrscheinlichkeitsmasse der Verteilung beinhaltet. 
...
Typisches Beispiel ist ein (wiederholter) Münzwurf.^[Bei jeder Wiederholung des Zufallexperiments 
...
Wie groß ist die Wahrscheinlichkeit bei $n=3$ Zügen $k=2$ Treffer zu erzielen (und $n-k=1$ Niete)? (Nennen wir dieses Ereignis der Kürze halber $A^{\prime}$ ).
De Trefferwahrscheinlichkeit ist (bei jedem Zug) $p=2/5$ und die 
Nietenwahrscheinlichkeit $1-p=3/5$.$\square$
:::
...
(*Multiplikationssatz*, @eq-multtheorem), vgl. @fig-baum3.
Die Summe der Wahrscheinlichkeiten der Pfade ist dann die gesuchte Wahrscheinlichkeit (*Additionssatz*, @eq-add-disjunkt).
Diagramme zeichnen ist einfach, dauert aber.


Beachtet man die *verschiedenen Reihenfolgen nicht*  (in @fig-baum3), 
so zählt man 3 günstige Pfade (vgl. @fig-sort3):
...
```{mermaid}
%%| fig-cap: "Baumdiagramm für das Ziehen von 2 Treffern und 1 Niete"
%%| label: fig-baum3
flowchart LR
  A[Start] -->B[Zug 1 - T]
  A -->C[Zug 1 - T]
...
Wir könnten auch R auffordern, die Anzahl der günstigen Pfade zu berechnen, s. @eq-binkoeff:
...
Damit ist die Wahrscheinlichkeit des gesuchten Ereignisses $A^{\prime}$ (2 Treffer bei 3 Zügen) gleich der Anzahl der günstigen Pfade mal der Wahrscheinlichkeit eines Pfades, , s. @eq-binkoeff-hand:
...
Das ist komfortabler als selber rechenn.
...
Der R-Befehl `choose` berechnet den Binomialkoeffizienten.^[Bei Taschenrechnern ist das oft als "nCr" zu finden.]
...
Das sind also `r round(p_weniger_als_4, 4)` oder 0.0003, also 0.03% Wahrscheinlichkeit, dass die Pumpstation ausfällt.
...
Die Anzahl der (günstigen) Pfade kann man mit dem *Binomialkoeffizient* ausrechnen, den man so darstellt, s. @eq-binkoeff.^[wobei gelten muss $n \ge k$]
...
müssten wir die Wahrscheinlichkeiten von 0 bis 15 Treffern addieren.
...
Was ist die Wahrscheinlichkeit bei 3 Münzwürfen (genau) 3 Treffer (Kopf) zu erzielen, s. @fig-p-bin-exms?
...
:::{#def-logarithmus}
Der Logarithmus von einer Zahl $a$ zur Basis $b$ ist die Zahl $x$, mit der man $b$ potenzieren muss, um $a$ zu erhalten. $\square$
:::
...
Bei einer Standardnormalverteilung gilt, s. @eq-standardnormal:

$$X \sim \mathcal{N}(0, 1)$${#eq-standardnormal}
...
den ein Wert vom Mittelwernt entfernt ist, s. @eq-ztrans.


$$z = \frac{x - \mu}{\sigma}$${#eq-ztrans}
...
- [alphafehler-inflation3](https://sebastiansauer.github.io/Datenwerk/posts/alphafehler-inflation3/alphafehler-inflation3.html)
- [alphafehler-inflation4](https://sebastiansauer.github.io/Datenwerk/posts/alphafehler-inflation4/alphafehler-inflation4.html)
- [iq1a](https://sebastiansauer.github.io/Datenwerk/posts/iq01a/)
- [iq2a](https://sebastiansauer.github.io/Datenwerk/posts/iq02a/)
- [iq3a](https://sebastiansauer.github.io/Datenwerk/posts/iq03a/)
- [simu-uniform](https://sebastiansauer.github.io/Datenwerk/posts/simu-uniform/)
- [simu-unif2](https://sebastiansauer.github.io/Datenwerk/posts/simu-unif2/)
- [simu-unif3](https://sebastiansauer.github.io/Datenwerk/posts/simu-unif3/)
- [Quiz zum Thema Verteilungen](https://sebastiansauer.github.io/Datenwerk/#category=Verteilungen-Quiz24)
- [Bsp-Binomial](https://sebastiansauer.github.io/Datenwerk/posts/bsp-binomial/bsp-binomial)


### Aufgaben, für die man einen Computer braucht

- [alphafehler-inflation2](https://sebastiansauer.github.io/Datenwerk/posts/alphafehler-inflation2/alphafehler-inflation2.html)
- [Quiz (Aufgabensammlung) zu Verteilungen](https://sebastiansauer.github.io/Datenwerk/#category=Verteilungen-Quiz)
- [wuerfel01](https://sebastiansauer.github.io/Datenwerk/posts/wuerfel01/wuerfel01.html)
- [wuerfel02](https://sebastiansauer.github.io/Datenwerk/posts/wuerfel02/wuerfel02.html)
- [wuerfel03](https://sebastiansauer.github.io/Datenwerk/posts/wuerfel03/wuerfel03.html)
- [wuerfel04](https://sebastiansauer.github.io/Datenwerk/posts/wuerfel04/wuerfel04.html)
- [iq01](https://sebastiansauer.github.io/Datenwerk/posts/iq01/iq01)
- [iq02](https://sebastiansauer.github.io/Datenwerk/posts/iq02/iq02)
- [iq03](https://sebastiansauer.github.io/Datenwerk/posts/iq03/iq03)
- [iq04](https://sebastiansauer.github.io/Datenwerk/posts/iq04/iq04)
- [iq05](https://sebastiansauer.github.io/Datenwerk/posts/iq05/iq05)
- [iq06](https://sebastiansauer.github.io/Datenwerk/posts/iq06/iq06)
- [iq07](https://sebastiansauer.github.io/Datenwerk/posts/iq07/iq07)
- [iq08](https://sebastiansauer.github.io/Datenwerk/posts/iq08/iq08)
<!-- - [iq09](https://sebastiansauer.github.io/Datenwerk/posts/iq09/iq09) -->
<!-- - [iq10](https://sebastiansauer.github.io/Datenwerk/posts/iq010/iq10) -->
- [Bus1](https://sebastiansauer.github.io/Datenwerk/posts/bus1/bus1)
