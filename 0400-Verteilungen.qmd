...
```{r}
#| echo: false
#| fig-cap: Kumulierte Häufigkeitsverteilung, d.h. die Verteilungsfunktion $F(X \le x_i)$
...
<!-- ```{r} -->
<!-- #| echo: false -->
<!-- #| label: "Wie groß ist die Wahrscheinlichkeit, zwischen 0 und 5 Minuten auf den Bus zu warten? 50 Prozent!" -->
<!-- #| fig-cap: fig-p05 -->
<!-- #| warning: false -->
<!-- p_bus2 <- -->
<!--   uniform_Plot(0, 10) + -->
...
<!-- p_bus2 -->
<!-- ggsave("img/p_bus2.png", width = 7, height = 5) -->
<!-- ``` -->
