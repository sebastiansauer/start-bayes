...
wie im Buch [Statistik1](https://statistik1.netlify.app/) von @sauer2025 vorgestellt, insbesondere im Kapitel ["Rahmen"](https://statistik1.netlify.app/010-rahmen#was-sind-daten).
...
:::{#def-verteilung}
### Verteilung
Eine Wahrscheinlichkeitsverteilung (bzw. eine HÄufigkeitsverteilung) beschreibt, wie wahrscheinlich (häufig) die Ergebnisse einer Variablen sind. $\square$
:::
...
Lies: "Wähle aus $n$ möglichen Ereignissen (Pfade im Baum) $k$ günstige 
...
Sie sind auf einer Party. Großartige Feier. Es wird spät, und langsam wird es Zeit,
nach Hause zu fahren. Heute sind Sie der Fahrer.
In Ihrem Auto haben Sie noch 2 freie Plätze: 💺💺. 
Aber 4 Ihrer Freunde möchten bei Ihnen mitfahren.
Da stellt sich also die Frage: Wen wählen Sie aus?
...
Das sind 2 Möglichkeiten: Für den 1. freien Sitz haben Sie die Wahl zwischen 2 Personen,
für den 2. freien Sitz dann nur noch eine Wahl.
Das macht also $2!$ Variationen -- davon behalten wir nur eine.
Wir "schneiden" also jeden 2. Baumast ab, teilen also die Anzahl der Äste (Pfade)
durch 2.
...
:::{#exr-binom}
️ Was fällt Ihnen bei der Binomialverteilung auf? Ist sie symmetrisch? Verändert sich die Wahrscheinlichkeit von einer Trefferzahl zur nächsten linear?
:::
...
Die Wahrscheinlichkeit, dass mind. 5 Motoren arbeiten beträgt also ca. 
`r round(p_mind_5, 4)`.
...
ps_df |> 
  ...
  labs(y = "Wahrscheinlichkeit (gerundet auf 3 Dezimalstellen)",
     x = "Anzahl der funktionerenden Motoren" ) 
```
