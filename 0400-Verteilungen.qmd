...
Bei *stetigen* Zufallsvariablen $X$ geht man von unendlich vielen Ausprägungen aus; die Wahrscheinlichkeit einer bestimmten Ausprägung ist Null: $Pr(X=x_j)=0, \quad j=1,...,+\infty \square$.
:::
...
(Nennen wir dieses Ereignis der Kürze halber $A^{\prime}$).
...
Wir könnten auch R auffordern, die Anzahl der günstigen Pfade zu berechnen, s. @thm-binkoeff:
...
Die Wahrscheinlichkeit, bei 3 Zügen 2 Treffer zu erzielen, beträgt also ca. 29%, vgl. @eq-binkoeff-hand.
