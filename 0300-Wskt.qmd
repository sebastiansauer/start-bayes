...
:::{#exm-grundraum}
Beobachtet man beim Würfelwurf (s. @fig-wurfel) die oben liegende Augenzahl, so ist 
...
Left column
:::
![Ein (sechsseitiger) Würfel](img/Dice_2005.jpg)
...
:::{#def-macht}
### Mächtigkeit
Die Anzahl der Elementarereignisse eines Ereignismraum nennt man die Mächtigkeit (des Ereignisraums).$\square$
...
## Anforderungen an Wahrscheinlichkeiten

Wir richten eine Reihe von Forderungen an das Rechnen mit Wahrscheinlichkeiten, die direkt plausibel erscheinen:^[Ein Herr Kolmogorov hat das mal aufgeschrieben.]
