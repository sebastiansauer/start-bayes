...
:::{#def-macht}
### Mächtigkeit
Die Anzahl der Elementarereignisse eines Ereignisraums nennt man die Mächtigkeit (des Ergebnisraums).^[Die Menge aller Teilmengen einer Menge $A$ nennt man die *Potenzmenge* $\mathcal{P}(A)$, vgl. [hier](https://de.wikipedia.org/wiki/Datei:Hasse_diagram_of_powerset_of_3.svg).]$\square$
:::
