...
Dann gilt: $P(A|B) = P(A) = P(A|\neg B). \square$^[Exakte Gleichheit ist in dieser Welt empirisch schwer zu finden. Daher kann man vereinbaren, dass Unabhängigkeit erfüllt ist, wenn die Gleichheit "einigermaßen" oder "ziemlich" gilt, die Gleichheit gewissermaßen "praktisch bedeutsam" ist.]
:::
...
Man kann also die "Gleichung drehen".$\square$
:::
...
Sie müssen in der App noch die Zahl der Bohnen ($n$) und die Zahl der scheusslichen Bohnen ($x$) einstellen.$\square$
:::
...
Einfacher als das Rechnen mit Wahrscheinlichkeiten ist es in solchen Fällen, wenn man anstelle von Wahrscheinlichkeiten absolute Häufigkeiten zum Rechnen verwendet.
...
[Diese App lässt dich herausfinden, ob du wirklich krank bist, wenn der Arzt es bheauptet.](https://www.geogebra.org/m/tkdfxa8f)
...
- [Additionssatz1](https://datenwerk.netlify.app/posts/additionssatz1/additionssatz1)
- [Nerd-gelockert](https://datenwerk.netlify.app/posts/nerd-gelockert/nerd-gelockert) 
- [Urne1](https://datenwerk.netlify.app/posts/urne1/urne1) 
- [Urne2](https://datenwerk.netlify.app/posts/urne2/urne2)
- [k-coins-k-hits](https://datenwerk.netlify.app/posts/k-coins-k-hits/k-coins-k-hits)
- [Klausur-raten](https://datenwerk.netlify.app/posts/klausur-raten/klausur-raten) 

- [Gem-Wskt1](https://datenwerk.netlify.app/posts/gem-wskt1/gem-wskt1)
- [Gem-Wskt2](https://datenwerk.netlify.app/posts/gem-wskt2/gem-wskt2)
- [Gem-Wskt3](https://datenwerk.netlify.app/posts/gem-wskt3/gem-wskt3)
- [wuerfel05](https://datenwerk.netlify.app/posts/wuerfel05/wuerfel05)
- [wuerfel06](https://datenwerk.netlify.app/posts/wuerfel06/wuerfel06)

- [Bed-Wskt1](https://datenwerk.netlify.app/posts/bed-wskt1/bed-wskt1)
- [Bed-Wskt2](https://datenwerk.netlify.app/posts/bed-wskt2/bed-wskt2)
- [Bed-Wskt3](https://datenwerk.netlify.app/posts/bed-wskt3/bed-wskt3)

- [mtcars-abhaengig](https://datenwerk.netlify.app/posts/mtcars-abhaengig/mtcars-abhaengig.html)
- [mtcars-abhaengig-var2](https://datenwerk.netlify.app/posts/mtcars-abhaengig_var2/mtcars-abhaengig_var2)
- [mtcars-abhaengig_var3](https://datenwerk.netlify.app/posts/mtcars-abhaengig_var3/mtcars-abhaengig_var3)
...
- [totale-Wskt1](https://datenwerk.netlify.app/posts/totale-wskt1/totale-wskt1)
- [Krebs1](https://datenwerk.netlify.app/posts/krebs1/krebs1)
- [Bayes-Theorem1](https://datenwerk.netlify.app/posts/bayes-theorem1/bayes-theorem1) 
