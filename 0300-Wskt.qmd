...
Die formallogische Konzeption von Wahrscheinlichkeit sieht Wahrscheinlichkeit als Erweiterung der formalen Logik.
...
(1
als die (nicht sichere) Wahrscheinlichkeit $0<p<1$, gesehen [@briggs2016], s. @fig-prob-logic.
...
aber auch ohne das Testen können wir eine stringente Aussage (basierend auf dem Indifferenzprinzip (s. @def-indifferenzprinzip) der $n$ Elementarereignisse) zur Wahrscheinlichkeit eines bestimmten (Elementar-)Ereignisses $A$ kommen [@briggs2016], s. @eq-briggs.
...
:::{#def-add-disjunkt}
### Additionssatz für disjunkte Ereignisse
Die Wahrscheinlichkeit, dass mindestens eines der beiden Ereignisse eintritt, ist die Summe der Einzelwahrscheinlichkeiten, s. @eq-add-disjunkt.

$$P(A \cup B) = P(A) + P(B) \square$${#eq-add-disjunkt}
$\square$
:::
...
ist gleich der Summe ihrer Wahrscheinlichkeiten minus ihrer gemeinsamen Wahrscheinlichkeit, s. @eq-add und @fig-add.
...
In diesem Fall verändert sich unser Wissen über die Wahrscheinlihkeit von $A$, 
wenn wir wissen, 
...
Wenn $A$ unabhängig zu $B$ ist auch $B$ unabhängig zu $A$, s. @eq-indep-symm.

$$Pr(A|B) = Pr(A) \leftrightarrow Pr(B|A) = Pr(B)$${#eq-indep-symm}
...
s. @fig-ab verdeutlicht dies für zwei unabhängige Ereignisse.
Man schreibt "A und B" als $A \cap B$ und liest "A geschnitten B".
...
$$Pr(A \cap B) = Pr(A) \cdot Pr(B)$$ {#eq-multtheorem}

Man beachte, dass es egal ist, ob $A$ gemeinsam mit $B$ oder $B$ gemeinsam mit $A$ eintreten: $Pr(A \cap B) = Pr(B \cap A)$.^[Man spricht auch von *Symmetrie* der Multiplikation.]
...
s. @eq-gem-wskt-abh. $\square$
:::

$$Pr(A \cap B) = Pr(A) \cdot Pr(B|A)$$ {#eq-gem-wskt-abh}
...
$$P(❄️ \text{ und } ⛈️) = P(⛈️ |❄️ ) \cdot P(❄️) =  P(❄️ |⛈️ ) \cdot P(⛈️)$${#eq-kalt-regen-emoji}


Man kann  die "Gleichung drehen"^[Der Multiplikationssatz ist symmetrisch]: 

$$P(❄️ \text{ und } ⛈️) = P(⛈️ \text{ und } ❄️)$${#eq-kalt-regen-emoji2} $\square$
:::
...
1. [Additionssatz1](https://sebastiansauer.github.io/Datenwerk/posts/additionssatz1/additionssatz1.html)
2. [Nerd-gelockert](https://sebastiansauer.github.io/Datenwerk/posts/nerd-gelockert/nerd-gelockert.html) 
3. [Urne1](https://sebastiansauer.github.io/Datenwerk/posts/urne1/urne1.html) 
3. [Urne2](https://sebastiansauer.github.io/Datenwerk/posts/urne2/urne2.html)
3. [k-coins-k-hits](https://sebastiansauer.github.io/Datenwerk/posts/k-coins-k-hits/k-coins-k-hits.html)
5. [sicherheit](https://sebastiansauer.github.io/Datenwerk/posts/sicherheit/sicherheit.html)
4. [sicherheit2](https://sebastiansauer.github.io/Datenwerk/posts/sicherheit2/sicherheit2.html)
6. [Klausuren-bestehen](https://sebastiansauer.github.io/Datenwerk/posts/klausuren-bestehen/klausuren-bestehen.html)
3. [Gem-Wskt1](https://sebastiansauer.github.io/Datenwerk/posts/gem-wskt1/gem-wskt1.html)
3. [Gem-Wskt2](https://sebastiansauer.github.io/Datenwerk/posts/gem-wskt2/gem-wskt2.html)
3. [Gem-Wskt3](https://sebastiansauer.github.io/Datenwerk/posts/gem-wskt3/gem-wskt3.html)
3. [Gem-Wskt4](https://sebastiansauer.github.io/Datenwerk/posts/gem-wskt4)
3. [wuerfel05](https://sebastiansauer.github.io/Datenwerk/posts/wuerfel05/wuerfel05)
3. [wuerfel06](https://sebastiansauer.github.io/Datenwerk/posts/wuerfel06/wuerfel06)
3. [Bed-Wskt1](https://sebastiansauer.github.io/Datenwerk/posts/bed-wskt1/bed-wskt1.html)
3. [Bed-Wskt2](https://sebastiansauer.github.io/Datenwerk/posts/bed-wskt2/bed-wskt2.html)
3. [Bed-Wskt3](https://sebastiansauer.github.io/Datenwerk/posts/bed-wskt3/bed-wskt3.htmlv)
3. [voll-normal](https://sebastiansauer.github.io/Datenwerk/posts/voll-normal)
3. [corona-blutgruppe](https://sebastiansauer.github.io/Datenwerk/posts/corona-blutgruppe/corona-blutgruppe.html)
3. [totale-Wskt1](https://sebastiansauer.github.io/Datenwerk/posts/totale-wskt1/totale-wskt1.html)
5. [wskt-quiz14](https://sebastiansauer.github.io/Datenwerk/posts/wskt-quiz14/wskt-quiz14.html)
5. [wskt-quiz09](https://sebastiansauer.github.io/Datenwerk/posts/wskt-quiz09/wskt-quiz09.html)



### Aufgaben, für die man einen Computer braucht

1. [mtcars-abhaengig](https://sebastiansauer.github.io/Datenwerk/posts/mtcars-abhaengig/mtcars-abhaengig.html)
3. [mtcars-abhaengig-var2](https://sebastiansauer.github.io/Datenwerk/posts/mtcars-abhaengig_var2/mtcars-abhaengig_var2)
3. [mtcars-abhaengig_var3a](https://sebastiansauer.github.io/Datenwerk/posts/mtcars-abhaengig_var3a/mtcars-abhaengig_var3a)
4. [wskt-df-r](https://sebastiansauer.github.io/Datenwerk/posts/wskt-df-r/wskt-df-r) 
