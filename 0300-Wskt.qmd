...
[Bildquelle: Roger McLassus, Wikimedia, CC BY-SA 3.0](https://commons.wikimedia.org/w/index.php?curid=474827)
:::
...
Nutzen Sie diese [Animation zu Mengenoperationen](https://seeing-theory.brown.edu/compound-probability/index.html) als weitere Veranschaulichung.
...
![Die Wahrscheinlichkeit, dass eine Zufallsvariable einen Wert in einem bestimmten Intervall annimmt, entspricht dem Inhalt der Fläche unter dem Graphen der Wahrscheinlichkeitsdichtefunktion. Bildrechte: 4C, Wikipedia, CC-BY-SA.](img/260px-Integral_as_region_under_curve.svg.png){#fig-wdichte-sinnbild width=33%}
