...
Liegt keine Unabhängigkeit vor, so spricht man von (stochatistischer) *Abhängigkeit*, s. @thm-abh. 
...
:::{#def-totwskt}
### Totale Wahrscheinlichkeit
Bilden die Ereignisse $A_1, A_2, ..., A_n$ ein vollständiges Ereignissystem und ist $B$ ein beliebiges Ereignis dann gilt @thm-totale-wskt. $\square$
:::
