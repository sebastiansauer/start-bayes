...
Zahl! Treffer! Glück gehabt!^[?]$\square$
:::
...
In Erweiterung von @eq-briggs können wir für ein Laplace-Experiment schreiben:
...
wuerfel_tab %>% 
  ...
  annotate("label", x = 1000, y = 1/6, label = "0.167")
```
...
#| layout-ncol: 3
#| fig-subcap: 
#|   - "Wahrscheinlichkeit für Ereignis B: 50%"
#|   - "Wahrscheinlichkeit für Ereignis A: 50%"
#|   - "Wahrscheinlichkeit für Ereignis B gegeben A: 50%"
plot16a1
plot16a2
plot16c
```
...
Man beachte, dass stochastische Unabhängigkeit und kausale Unabhängigkeit unterschiedliche Dinge sind [@henze_stochastik_2019]: Stochastische Unabhängigkeit impliziert nicht kausale Unahbängigkeit.
...
Wie groß ist die Wahrscheinlichkeit, *mindestens eine* scheußliche Bohne zu erwischen?^[Die Wahrscheinlichkeit *keine* scheußliche Bohne zu ziehen ist $1 - (17/20 \cdot 16/19 \cdot 15/18) \approx `r Pr_nicht_keine_Bohne`$.]
