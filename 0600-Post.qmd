...
`bayesbox_g100` ist eine Bayesbox mit $W=6, N=9, g=100$.
...
![Quantile in 10%-Schriten durch die Verteilung von `samples_k100`](img/p_deciles.gif){#fig-quantiles-anim width=50%}
:::
...
Erstellen wir uns dazu mal eine Post-Verteilung (3 Treffer, 3 Würfe), s. @lst-d33 mit dem Objekt `bayesbox_3w_3v3`.
