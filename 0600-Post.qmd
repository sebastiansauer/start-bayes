...
Aufgrund der Apriori-Indifferenz entsprechen die Posteriori-Wahrscheinlichkeiten den Likelihoods. Die höchste Wahrscheinlichkeit (d.h. Likelihood) hat derjenige Parameterwert, zu dem die Daten am besten passen, und das ist 6/9 = 2/3. $\square$
:::
:::
...
Übrigens kann man die Berechnung der Bayes-Box auch automatisieren, s. @tbl-bayes-fun, z.B. so:^[Alternativ kann man auf die Funktion über das [R-Paket {prada}](https://github.com/sebastiansauer/prada) zugreifen.]

```{r}
#| label: tbl-bayes-fun
#| tbl-cap: "Eine Bayes-Box 'automatisiert' erstellt, mit Hilfe der Fuktion `bayesbox`"
