...
s. @lst-dbinom1, @fig-binom1a und @thm-dbinom1.
...
2. Die *Priori-Verteilung(en)* (die Wahrscheinlichkeit der Hypothese vor den Daten), a. @thm-prior-unif-globus
...
Unser Vorab-  bzw. *Apriori*-Wissen zu $p$ sei, dass uns alle Werte gleich ("uniform") plausibel erscheinen, s. @thm-prior-unif-globus.

$$\pi \sim \text{Unif}(0,1).$${#thm-prior-unif-globus}
...
Die Posteriori-Verteilung ist das Ergebnis des Bayes-Updates, s. @thm-post-globus1.
...
indem wir durch die Evidenz dividieren, s. @thm-poststand697.

$$\text{Post} = \frac{\text{Post}_{\text{unstand}}}{\text{Evidenz}} = \frac{0.025}{0.1} =0.25$${#thm-poststand697}
