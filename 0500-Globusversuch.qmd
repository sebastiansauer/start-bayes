...
Die Evidenz berechnet sich als Summe der Likelihoods über alle Ausprägungen von $D$, vgl. @def-totwskt:
...
Schauen wir uns die Bestandteile von Bayes' Theorem (@eq-bayes5) noch etwas näher an:
...
Wir erstellen uns eine kleine Tabelle, die man "Bayes-Box" nennen könnte.
...
$$\text{Post}_{\text{unstand}} = Pr(H) \cdot Pr(D|H) = 0.1 \cdot 0.27 = 0.027$${#eq-postunstand697}
...
$$\text{Post} = \frac{\text{Post}_{\text{unstand}}}{\text{Evidenz}} = \frac{0.027}{0.1} =0.27$${#eq-poststand697}
