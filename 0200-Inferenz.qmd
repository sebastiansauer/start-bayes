...
- Wie stark ist der (lineare) Zusammenhang $r$ von Größe und Gewicht (bei Erwachsenen) in der Grundgesamtheit?
...
:::{#exm-toni-lernt}
### Toni lernt für die Klausur
Oh nein, die Klausur im Fach Statistik steht an. 
Toni lernt ziemlich viel. 
Wie viel Punkte (von 100 möglichen) wird er wohl erzielen?
Ziehen wir ein einfaches statistisches Modell zur Rate,
um eine Vorhersage für den "Klausurerfolg" von Toni zu erhalten.
Wir können vom Modell eine einzelne Zahl (83) als Punkt-Schätzwert bzw. Vorhersagewert erhalten oder einen Schätzbereich (80-80 Punkte). $\square$
:::

Hier ist das Regressionsmodell für Toni (`lm_toni`), s. @lst-toni.
...
#| echo: false
#| fig-cap: "Noten und Lernzeit: Rohdaten (a) und mit Modell (b). Mittelwerte sind mit gestrichelten Linien eingezeichnet. Die Vorhersage für Toni ist farbig markiert. Toni hat 42 Stunden gelernt für die Klausur; das Modell sagt ihm 83 Punkte (von 100) bzw. einen Bereich von 80 bis 86 Punkten voraus."
#| layout-ncol: 2
#| fig-subcap: 
#|   - "Regressionsgerade mit Punkt-Vorhersage für Toni"
#|   - "Regressionsgerade mit Vorhersagebereich (und herangezoomt) für Toni"
...
Inferenzstatistische Schlüsse sind mit *Ungewissheit* (Unsicherheit über die Zuverlässigkeit der Ergebnisse) behaftet: 
Schließlich kennt man nur einen Teil (die Stichprobe) eines Ganzen (die Population), möchte aber vom Teil auf das Ganze schließen.
...
#| echo: false
#| fig-subcap:
#|   - "Ungewissheit für den Achsenabschnitt"
#|   - "Ungewissheit für die Steigung der Regressionsgeraden"
...
Wir haben gesesehen, dass wir die Werte der Parameter nur mit Ungewissheit angegeben können (s. @fig-betas-ungewiss und @fig-resid-var).
...
3. Erklären Sie, was "statistisch signifikanter Zusammenhang" hier bedeutet? $\square$
:::
...
@exr-stmartphone addiction ist eine lohnende Aufgabe, 
falls Sie diese Aufgabe noch nicht bearbeitet haben.
...
14. [Quiz zu Verteilungen](https://sebastiansauer.github.io/Datenwerk/index.html#category=Verteilungen-Quiz) -- nur die Aufgaben, die ohne einen Computer bzw. ohne R zu lösen sind
