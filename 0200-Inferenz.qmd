...
Statistische Inferenz hat zum Ziel, vom Teil aufs Ganze zu schließen, bzw. vom Konkreten auf das Abstrakte.^[Statistische Inferenz sieht sich drei "Herausforderungen" gegenüber, laut  @gelman_regression_2021, Kap. 1.1. 
...
Für jede beliebige Statistik (Kennzahl von Stichprobendaten) kann man die Methoden der Inferenzstatistik verwenden, s. Tabelle @tbl-kennwerte.
...
Lesen Sie [diesen Post](https://setosa.io/ev/ordinary-least-squares-regression/), der Ihnen mit Hilfe von Bildern und Anminationen (okay, und etwas) Text die Grundlagen der Regressionsanalyse erklärt.$\square$
:::
...
- ‍♀ Der p-Wert würde ein inhaltlich bedeutsames, praktisch signifikantes Ergebnis anzeigen. badenes-ribera_misconceptions_2016-1
