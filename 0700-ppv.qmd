...
Hilfe für die Funktion `gghistogram()` finden Sie auf der [Hilfeseite der Funktion](https://rpkgs.datanovia.com/ggpubr/reference/gghistogram.html)^[<https://rpkgs.datanovia.com/ggpubr/reference/gghistogram.html>].
...
Sie finden Details zur Aufgabenstellung (sowie die Lösung 🙈) [hier](https://datenwerk.netlify.app/posts/postvert-vis-zwielicht/postvert-vis-zwielicht).^[<https://datenwerk.netlify.app/posts/postvert-vis-zwielicht/postvert-vis-zwielicht>] $\square$
:::
...
Unsere Stichprobenverteilung zeigt, welche Trefferzahlen bei einem bestimmten Parameterwert, 
z. B. $\pi=.7$ in welchen Anteilen zu erwarten sind.
...
Einige einflussreiche Gruppen an Statistikis [unterstützen diese Haltung](https://www.routledge.com/Predictive-Inference/Geisser/p/book/9780367449919)^[<https://www.routledge.com/Predictive-Inference/Geisser/p/book/9780367449919>]
...
[Wir brauchen die PPV](https://imgflip.com/i/6zm1hh)^[<https://imgflip.com/i/6zm1hh>]. Ohne die PPV können wir nicht seriös abschätzen, wie viel Ungewissheit in unseren Vorhersagen steckt.
...
if (knitr:::is_html_output()) {
  ...
  knitr::include_graphics("img/post-pred-ppv-anim-static.png")
}
```
...
[Quelle: R. McElreath](https://twitter.com/rlmcelreath/status/1448978045247893505)^[<https://twitter.com/rlmcelreath/status/1448978045247893505>]
...
quiz_ppv_files <- list(
  "exr/stichprobenvert-vs-postvert-schoice/stichprobenvert-vs-postvert-schoice.Rmd",
  "exr/likelihood-zwielicht-schoice/likelihood-zwielicht-schoice.Rmd",
  "exr/ppv-definition-schoice/ppv-definition-schoice.Rmd",
  "exr/ppv-vs-post-parameterwerte-schoice/ppv-vs-post-parameterwerte-schoice.Rmd",
  "exr/zwei-arten-ungewissheit-schoice/zwei-arten-ungewissheit-schoice.Rmd",
  "exr/dbinom-vs-rbinom-schoice/dbinom-vs-rbinom-schoice.Rmd",
  "exr/uebergewissheit-punktschaetzer-schoice/uebergewissheit-punktschaetzer-schoice.Rmd",
  "exr/drei-verteilungen-vergleich-schoice/drei-verteilungen-vergleich-schoice.Rmd",
  "exr/ppv-mixtur-treffer-schoice/ppv-mixtur-treffer-schoice.Rmd",
  "exr/ppv-mixtur-keine-treffer-schoice/ppv-mixtur-keine-treffer-schoice.Rmd"
)
```
...
#| message: false
#| results: asis
exams2forms(quiz_ppv_files, n = 1)
```
