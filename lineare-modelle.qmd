...
Wir nennen es `m43a`^[Wer ist hier für die Namensgebung zuständig? Besoffen oder was?].
...
Einfacher ist die Syntax, wenn man die Funktion `estimate_expectation` benutzt.
...
x <- posterior_predictive_check(m43a)
x
