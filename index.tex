...
\item
  ...
  und seine Freunde}.
\item
  Für die Bayes-Inferenz brauchen Sie\footnote{nicht gleich zu Beginn,
    aber nach 2-3 Wochen} zusätzliche Software, was leider etwas
  Zusatzaufwand erfordert. Lesen Sie
  \href{https://data-se.netlify.app/2022/01/28/bayes-software-installieren-f\%C3\%BCr-r/}{hier}
  die Hinweise dazu.
\item
  Installieren Sie die folgende R-Pakete\footnote{falls Sie die Pakete
    schon installiert haben, könnten Sie mal in RStudio auf
...
Dieses Dokument wurde erzeugt am/um 2022-11-29 07:57:34.
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Hinweis}, arc=.35mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, opacityback=0, toprule=.15mm, leftrule=.75mm, toptitle=1mm, breakable, colbacktitle=quarto-callout-note-color!10!white, rightrule=.15mm, titlerule=0mm, left=2mm, bottomrule=.15mm, colback=white, opacitybacktitle=0.6]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Wichtig}, arc=.35mm, bottomtitle=1mm, colframe=quarto-callout-important-color-frame, opacityback=0, toprule=.15mm, leftrule=.75mm, toptitle=1mm, breakable, colbacktitle=quarto-callout-important-color!10!white, rightrule=.15mm, titlerule=0mm, left=2mm, bottomrule=.15mm, colback=white, opacitybacktitle=0.6]
...
s. Abb. Abbildung~\ref{fig-xy}, die ein Sinnbild eines statistischen
Modells widergibt.
...
{\centering \includegraphics[width=5.5in,height=3.5in]{./Inferenz_files/figure-latex/mermaid-figure-4.png}
...
\caption{\label{fig-xy}Sinnbild eines stastistischen Modells}

\end{figure}

Das Diagramm hat Sie nicht so vom Hocker? Okay, ein statistisches Modell
kann natürlich komplexer sein, z.B. wie in Abb. Abbildung~\ref{fig-xy2}
dargestellt.
...
\caption{\label{fig-xy2}Sinnbild eines stastistischen Modells, mit zwei
Inputvariablen (Ursachen)}
...
Abbildung~\ref{fig-punktschaetzer}.
...
\caption{\label{fig-punktschaetzer}Eine Punktschätzung}
...
In Abb. Abbildung~\ref{fig-ungewiss1} ist die Ungewissheit in den
Regressionskoeffizienten visualisiert: Wie sicher sind wir uns zur
Stärke des Zusammenhangs von X und Y?

\begin{figure}

{\centering \includegraphics{./Inferenz_files/figure-pdf/fig-ungewiss1-1.pdf}

}

\caption{\label{fig-ungewiss1}Ungewissheit in den
Regressionskoeffizienten}

\end{figure}

Auch wenn wir uns \emph{sicher} im Hinblick auf die Regressionsgewichte
in Abb. Abbildung~\ref{fig-ungewiss1} \emph{bliebe eine
Restungewissheit}: Unsere Schätzungen wären nicht sicher, nicht
fehlerfrei. Das liegt daran, da das Modell nicht alle Einflüsse auf Y
berücksichtigt, sondern nur einen, hier als X bezeichnet.
...
der Ungewissheit berücksichtigt.

Das Vorhersage-Intervall berücksichtigt Ungewissheit in
\(\beta_0, \beta_1, \epsilon\) bei der Vorhersage von \(\hat{y_i}\).
...
Sagen wir, wir finden, dass in einem Modell ein 95\%-Konfidenzintervall
für den Anteil der R-Fans angegeben wird, dass sich von 40 bis 44
Prozent erstreckt.

Dieser Befund läßt sich so interpretieren:

``Laut Modell liegt der gesuchte Anteil mit einer Wahrscheinlichkeit von
95\% im Bereich von 44 bis 44 Prozentpunkten.''
...
kennen, auf Baiss unseres Modells?''
...
\caption{Frequentist wettet mit Bayesianer}
...
\includegraphics[width=0.25\textwidth,height=\textheight]{./img/1024px-Coin-155597.svg.png}
...
Schnitt \(A\cap B\) doppelt erfasst. Er muss daher noch abgezogen
werden:

\[P(A \cup B) = P(A) + P(B) - P(A\cap B)\] \(A \cup B\)

\includegraphics[width=0.25\textwidth,height=\textheight]{./img/Venn0111.svg.png}

\(A \cap B\)

\includegraphics[width=0.25\textwidth,height=\textheight]{./img/Venn0001.svg.png}
...
\emph{Abhängig}, s. Abbildung~\ref{fig-abh1}.

\(P(A|B) \ne Pr(A) \ne Pr(A|\neg B)\)

\begin{figure}

{\centering \includegraphics[width=1\textwidth,height=\textheight]{./Wskt_files/figure-pdf/fig-abh1-1.pdf}

}

\caption{\label{fig-abh1}Abhängigkeit zweier Ereignisse}

\end{figure}

Überleben auf der Titanic ist offenbar \emph{abhängig} von der
Passagierklasse.

\emph{Unabhängig}, s. Abb. Abbildung~\ref{fig-unabh1}.

\(P(A|B) = Pr(A) = Pr(A|\neg B)\)

\begin{figure}

{\centering \includegraphics[width=1\textwidth,height=\textheight]{./Wskt_files/figure-pdf/fig-unabh1-1.pdf}

}

\caption{\label{fig-unabh1}UnAbhängigkeit zweier Ereignisse}

\end{figure}

Ereigsis \emph{Überleben} auf der Titanic ist \emph{un}abhängig vom
Ereignis \emph{Alter ist eine Primzahl}.
...
Abb. Abbildung~\ref{fig-mtcars-freq} visualisiert die
...
Klassenbildung diskretisieren, s. Abb. Abbildung~\ref{fig-mtcars-hp}.

\begin{figure}

{\centering \includegraphics{./Verteilungen_files/figure-pdf/fig-mtcars-hp-1.pdf}

}

\caption{\label{fig-mtcars-hp}Häufigkeitsverteilng einer stetigen
Variablen, diskretisiert in 10 ``Körbe'' oder Gruppen}
...
Warhscheinlichkeitsverteilungen dienen dazu, Ereignissen einer
...
{\centering \includegraphics{./img/shower-data.png}
...
{\centering \includegraphics{./img/norm-100-15.png}
...
Intelligenz (IQ) verwendet wird.

\includegraphics{./Verteilungen_files/figure-pdf/unnamed-chunk-34-1.pdf}
...
Betrachten wir einige wichtigen Quantile:

\includegraphics{./Verteilungen_files/figure-pdf/unnamed-chunk-42-1.pdf}
...
\includegraphics[width=2.27in,height=\textheight]{./img/10_Deutsche_Mark_-_detail.png}

Uni Greifswald, Public domain, via Wikimedia Commons
...
{\centering \includegraphics{./img/170px-Golem_and_Loew.jpg}

}

\caption{Der Golem von Prag}
...
wörtlich ausführt. Die Geschichte besagt, dass ein Rabbi mit
Zauberkräften den Golem aus Lehm erschuf, um die jüdische Bevölkerung
der Stadt zu schätzen. Bei kluger Führung kann ein Golem Nützliches
vollbringen. Bei unüberlegter Verwendung wird er jedoch großen Schaden
anrichten.
...
{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{./img/earth.png}
...
{\centering \includegraphics[width=5.5in,height=3.5in]{./Globusversuch_files/figure-latex/mermaid-figure-3.png}
...
Bayes-Gitter) genannt: s. \textbf{?@tbl-post1}.
...
##  2   0.11     1       0            0     0   
##  3   0.22     1       0            0     0.01
##  4   0.33     1       0.03         0.03  0.04
##  5   0.44     1       0.11         0.11  0.12
##  6   0.56     1       0.22         0.22  0.24
##  7   0.67     1       0.27         0.27  0.3 
##  8   0.78     1       0.2          0.2   0.23
##  9   0.89     1       0.06         0.06  0.06
## 10   1        1       0            0     0
\end{verbatim}
...
\begin{verbatim}
##   [1] 0.78 0.67 0.78 0.56 0.67 0.67 0.44 0.33 0.56 0.44 0.67 0.78 0.33 0.44 0.56
##  [16] 0.78 0.56 0.56 0.67 0.67 0.67 0.78 0.56 0.78 0.56 0.56 0.78 0.78 0.67 0.56
##  [31] 0.56 0.56 0.56 0.67 0.67 0.78 0.56 0.56 0.67 0.33 0.89 0.56 0.89 0.78 0.44
##  [46] 0.56 0.67 0.89 0.78 0.67 0.67 0.78 0.44 0.56 0.67 0.67 0.44 0.56 0.67 0.78
##  [61] 0.56 0.33 0.56 0.89 0.78 0.89 0.78 0.44 0.67 0.56 0.78 0.78 0.56 0.56 0.67
##  [76] 0.56 0.44 0.44 0.44 0.56 0.56 0.44 0.67 0.44 0.56 0.67 0.67 0.78 0.89 0.78
##  [91] 0.44 0.67 0.67 0.67 0.78 0.44 0.67 0.56 0.67 0.67
\end{verbatim}
...
{\centering \includegraphics{./img/p-vs-q.png}
...
\DocumentationTok{\#\#   \textless{}lgl\textgreater{}          \textless{}int\textgreater{}}
\DocumentationTok{\#\# 1 FALSE           8303}
\DocumentationTok{\#\# 2 TRUE            1697}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#   \textless{}lgl\textgreater{}                          \textless{}int\textgreater{}}
\DocumentationTok{\#\# 1 FALSE                           4523}
\DocumentationTok{\#\# 2 TRUE                            5477}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# 1  0.452    45.2}
\DocumentationTok{\#\# 2  0.548    54.8}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{./Post_files/figure-pdf/unnamed-chunk-6-1.pdf}
...
Abbildung~\ref{fig-schief-pi}.

\begin{figure}

{\centering \includegraphics{./Post_files/figure-pdf/fig-schief-pi-1.pdf}

}

\caption{\label{fig-schief-pi}Ein Perzentilintervall kann, wenn es dumm
läuft, den wahrscheinlichsten Parameterwert nicht enthalten, diesen Wert
also plausiblen Wert also zurückweisen. Das ist nicht so toll.}
...
\includegraphics{./Post_files/figure-pdf/unnamed-chunk-10-1.pdf}
...
sind, \emph{wenn} die Münze fair ist, Abbildung~\ref{fig-stiprovert}.
...
\textbf{?@fig-stripovert}. Ist dieser Anteil kleiner als 5\% (der
...
\DocumentationTok{\#\#   \textless{}lgl\textgreater{}                                                     \textless{}int\textgreater{}  \textless{}dbl\textgreater{}}
\DocumentationTok{\#\# 1 FALSE                                                      9424 0.942 }
\DocumentationTok{\#\# 2 TRUE                                                        576 0.0576}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#   \textless{}lgl\textgreater{}                       \textless{}int\textgreater{} \textless{}dbl\textgreater{}}
\DocumentationTok{\#\# 1 FALSE                        3253 0.325}
\DocumentationTok{\#\# 2 TRUE                         6747 0.675}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#  4  0.333}
\DocumentationTok{\#\#  5  0.667}
\DocumentationTok{\#\#  6  0.444}
...
{\centering \includegraphics{./gauss_files/figure-pdf/echo- true label- fig-kung2 fig-cap- Die gemeinsame Verteilung von Mittelwert und Streuung.-1.pdf}
...
Abbildung~\ref{fig-kung2} erlaubt uns, für jede Kombination von
Mittelwert und Streuung zu fragen, wie wahrscheinlich diese Kombination
ist.
...
\NormalTok{p\_m41\_post }\OtherTok{\textless{}{-}} 
\NormalTok{  m41\_post }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ mu, }\AttributeTok{y =}\NormalTok{ sigma) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{alpha =}\NormalTok{ .}\DecValTok{1}\NormalTok{) }

\NormalTok{ggExtra}\SpecialCharTok{::}\FunctionTok{ggMarginal}\NormalTok{(p\_m41\_post, }\AttributeTok{type =} \StringTok{"density"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics{./gauss_files/figure-pdf/Kung-5-bis-1.pdf}
...
\begin{Highlighting}[]
\NormalTok{m41\_post }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ mu)) }\SpecialCharTok{+} 
  \FunctionTok{geom\_histogram}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{./gauss_files/figure-pdf/unnamed-chunk-5-1.pdf}
...
\midrule()
\endhead
(Intercept) & 154.60 & (153.82, 155.39) & 100\% & 1.000 & 2933.00 &
Normal (154.60 +- 19.36) \\
\bottomrule()
\end{longtable}

Das Wesentliche: Unser Golem schätzt den Größenmittelwert der Kung auf
ca. 155cm bzw. auf einen Bereich von etwa 153.8180351 bis 155.3947801
schätzt.
...
\DocumentationTok{\#\#           \textless{}dbl\textgreater{} \textless{}dbl\textgreater{}}
\DocumentationTok{\#\# 1          155.  8.09}
\DocumentationTok{\#\# 2          155.  8.23}
\DocumentationTok{\#\# 3          155.  7.97}
\DocumentationTok{\#\# 4          155.  8.00}
\DocumentationTok{\#\# 5          154.  7.71}
\DocumentationTok{\#\# 6          154.  7.77}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#   \textless{}lgl\textgreater{}      \textless{}int\textgreater{} \textless{}dbl\textgreater{}}
\DocumentationTok{\#\# 1 FALSE       3363 0.841}
\DocumentationTok{\#\# 2 TRUE         637 0.159}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# mu        | [153.82, 155.39]}
\DocumentationTok{\#\# sigma     | [  7.21,   8.35]}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# (Intercept) | 154.60 | [153.82, 155.39] | 100\% | 1.000 | 2933.00 | Normal (154.60 +{-} 19.36)}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# Parameter   | Median |           95\% CI |   pd |  Rhat |     ESS |              Prior}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# (Intercept) | 154.60 | [153.81, 155.39] | 100\% | 1.001 | 3117.00 | Normal (178 +{-} 20)}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\#   \textless{}lgl\textgreater{}          \textless{}int\textgreater{} \textless{}dbl\textgreater{}}
\DocumentationTok{\#\# 1 FALSE           8307 0.831}
\DocumentationTok{\#\# 2 TRUE            1693 0.169}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Für jede Ausprägung des Prädiktors (\texttt{weight}), \(h_i\), wird
  eine Post-Verteilung für die abhängige Variable (\texttt{height})
  berechnet.
\item
...
{\centering \includegraphics{./lineare-modelle_files/figure-pdf/unnamed-chunk-22-1.pdf}
...
{\centering \includegraphics{./lineare-modelle_files/figure-pdf/unnamed-chunk-23-1.pdf}
...
{\centering \includegraphics{./img/bayesianMaster.jpg}
...
Und plotten diese, s. \textbf{?@fig-mu-at-45}.
...
\includegraphics{./lineare-modelle_files/figure-pdf/Post-Regression-befragen-17-1.pdf}
...
Die Verteilung der Größe bei einem Gewicht von 50kg ist weiter rechts
(Richtung höhere Größe) zentriert, s. Abbildung~\ref{fig-mu-at-50}.
...
\caption{\label{fig-mu-at-50}Post-Verteilung der Größe (laut unserem
Modell) bedingt auf ein Gewicht von 50 kg}
...
\texttt{predictive\_interval()} für jeden Prädiktorwert eine
Posteriori-Verteilung erstellt und das 5\%- sowie 95\%-Quantil
berechnet.
...
\includegraphics{./lineare-modelle_files/figure-pdf/unnamed-chunk-32-1.pdf}
...
bestimmten Prädiktorwert, z.B. bei einer Person mittleren Gewichts.

Wir können auch den Mittelwert über alle bedingten PPV anschauen,
sozusagen die ``Master-PPV'' oder ``unbedingte PPV'' oder schlicht PPV.
...
\DocumentationTok{\#\# 1  137.        155.  155.  173.}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# Parameter |          50\% ETI}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# height    | [144.62, 164.82]}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=1\textwidth,height=\textheight]{./img/41586_2021_3843_Fig2_HTML.png}
...
Mit \texttt{parameters(m10.1)} bekommt man die Parameter des Modells:
...
\midrule()
\endhead
(Intercept) & 77.53 & (73.43, 81.47) & 100\% & 1.000 & 3665.00 & Normal
(86.80 +- 51.03) \\
mom\_hs & 11.80 & (7.27, 16.41) & 100\% & 1.000 & 3580.00 & Normal (0.00
+- 124.21) \\
\bottomrule()
\end{longtable}
...
{\centering \includegraphics{./metrische-AV_files/figure-pdf/unnamed-chunk-7-1.pdf}
...
\NormalTok{  m10}\FloatTok{.1}\NormalTok{\_post }\SpecialCharTok{\%\textgreater{}\%} 
  \FunctionTok{summarise}\NormalTok{(}\AttributeTok{pi\_95 =} \FunctionTok{quantile}\NormalTok{(mom\_hs, }\FunctionTok{c}\NormalTok{(.}\DecValTok{025}\NormalTok{, .}\DecValTok{975}\NormalTok{)))}

\NormalTok{pi\_mom\_hs}
\DocumentationTok{\#\# \# A tibble: 2 x 1}
\DocumentationTok{\#\#   pi\_95}
\DocumentationTok{\#\#   \textless{}dbl\textgreater{}}
\DocumentationTok{\#\# 1  7.27}
\DocumentationTok{\#\# 2 16.4}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{./metrische-AV_files/figure-pdf/unnamed-chunk-12-1.pdf}
...
\includegraphics[width=1.67in,height=\textheight]{./img/5v5531.jpg}
...
\midrule()
\endhead
(Intercept) & 25.80 & (14.31, 37.70) & 100\% & 1.002 & 4115.00 & Normal
(86.80 +- 51.03) \\
mom\_iq & 0.61 & (0.50, 0.72) & 100\% & 1.001 & 4096.00 & Normal (0.00
+- 3.40) \\
\bottomrule()
\end{longtable}
...
{\centering \includegraphics{./metrische-AV_files/figure-pdf/Thema6-Teil2-4-1.pdf}
...
\DocumentationTok{\#\#  25.8615359   6.0145134   0.5622291}
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics{./metrische-AV_files/figure-pdf/Thema6-Teil2-5-1.pdf}
...
\DocumentationTok{\#\#    {-}10.472612     50.083445      0.957049     {-}0.469968}
\end{Highlighting}
\end{Shaded}

\includegraphics{./metrische-AV_files/figure-pdf/Thema6-Teil2-6-1.pdf}
...
\DocumentationTok{\#\#      85.4705704       2.8035933       0.9700819      {-}0.4860457}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{./metrische-AV_files/figure-pdf/plot-m10-5-1.pdf}
...
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# (Intercept)     | [81.21, 89.97] |   fixed | conditional}
\DocumentationTok{\#\# mom\_hs          | [{-}2.02,  7.57] |   fixed | conditional}
\DocumentationTok{\#\# mom\_iq\_c        | [ 0.68,  1.26] |   fixed | conditional}
\DocumentationTok{\#\# mom\_hs:mom\_iq\_c | [{-}0.79, {-}0.17] |   fixed | conditional}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# (Intercept)     | [81.10, 89.83]}
\DocumentationTok{\#\# mom\_hs          | [{-}1.98,  7.58]}
\DocumentationTok{\#\# mom\_iq\_c        | [ 0.69,  1.26]}
\DocumentationTok{\#\# mom\_hs:mom\_iq\_c | [{-}0.79, {-}0.17]}
\end{Highlighting}
\end{Shaded}
...
\caption{species=Adelie}\tabularnewline
\toprule()
\begin{minipage}[b]{\linewidth}\raggedright
Variable
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
\midrule()
\endhead
body\_mass\_g & 3700.66 & 458.57 & 0.29 & -0.57 & 151 & 1 \\
\bottomrule()
\end{longtable}
...
\includegraphics{./metrische-AV_files/figure-pdf/unnamed-chunk-24-1.pdf}

\includegraphics{./metrische-AV_files/figure-pdf/unnamed-chunk-25-1.pdf}
...
{\centering \includegraphics{./metrische-AV_files/figure-pdf/unnamed-chunk-26-1.pdf}
...
{\centering \includegraphics{./metrische-AV_files/figure-pdf/unnamed-chunk-39-1.pdf}
...
{\centering \includegraphics{./metrische-AV_files/figure-pdf/unnamed-chunk-49-1.pdf}
...
{\centering \includegraphics{./metrische-AV_files/figure-pdf/unnamed-chunk-53-1.pdf}
...
\includegraphics{./metrische-AV_files/figure-pdf/unnamed-chunk-58-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{ggplot}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x=}\ConstantTok{NA}\NormalTok{, }\AttributeTok{y=}\ConstantTok{NA}\NormalTok{)) }\SpecialCharTok{+}
  \FunctionTok{theme}\NormalTok{(}\AttributeTok{panel.background =} \FunctionTok{element\_rect}\NormalTok{(}\AttributeTok{fill =} \StringTok{\textquotesingle{}lightblue\textquotesingle{}}\NormalTok{))}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics[width=0.5\textwidth,height=\textheight]{./metrische-AV_files/figure-pdf/unnamed-chunk-59-1.pdf}
...
Daher kann man ein Modell verstehen als eine einfache Zusammenfassung
eines (ggf. hochdimensionalen) Variablenraumes.
...
\item
  ...
  vielleicht die Veränderung von \texttt{kid\_score} betrachten, wenn
  man von kleinsten zum größten Prädiktorwert geht.
\item
  Allerdings sind Extremwerte meist instabil (da sie von einer einzigen
  Beobachtung bestimmt werden).
\item
  Sinnvoller ist es daher, die Veränderung in der AV zu betrachten, wenn
  man den Prädiktor von ``unterdurchschittlich'' auf
  ``überdurchschnittlich'' ändert.
\item
  Das kann man mit \emph{z-Standardisierung} erreichen.
\end{itemize}
...
\tightlist
\item
  \emph{z-Standardisierung} bedeutet, eine Variable so zu
  transformieren, dass sie über einen Mittelwert von 0 und eine SD von 1
  verfügt:
\end{itemize}
...
{\centering \includegraphics{./metrische-AV_files/figure-pdf/unnamed-chunk-68-1.pdf}
...
\tightlist
\item
  Cohen (1988) definiert Effektstärken in Bezug auf
  Mittelwertsvergleiche anhand von \(d=(\mu_1 - \mu_o) / \sigma\).
\item
  ...
  \end{itemize}
\item
  Auf dieser Basis schlägt Kruschke (2018) einen Rope von \(\pm0.1\)
  vor.
\item
...
\item
  ...
  Sachverstand ersetzt werden sollen, wo immer möglich.
\item
  Man kann Effektstärken ineinander überführen, s.
  \href{https://www.escal.site/}{hier}, z.B. von Korrelation (\emph{r})
  zu Cohens \emph{d} oder \(R^2\).
\end{itemize}
...
\item
  ...
  \(x\) nur einen vernachlässigbaren Effekt auf \(y\) hat.
\item
  Ein vernachlässigbarer Effekt ist dabei \(\hat{y}= \pm 0.1 sd_y\).
\item
  Der ``praktisch ganze Wertebereich'' von \(x\) sei
  \(\bar{x} \pm 2 sd_x\).
\item
  ...
  Null, der Effekt also vernachlässigbar.
\item
  Das impliziert Rope-Grenzen von \(\beta_x = \pm 0.05\) für
...
\tightlist
\item
  Sind X und Y \emph{z-standardisiert}, so sind Korrelation und
...
\emph{zufällige} Streuung um \(y=0\) herum zeigen.
...
{\centering \includegraphics{./metrische-AV_files/figure-pdf/unnamed-chunk-75-1.pdf}
...
{\centering \includegraphics{./metrische-AV_files/figure-pdf/unnamed-chunk-76-1.pdf}
...
\item
  ...
  \texttt{kid-score\_z}.
\item
  Unten links (C): Die Residuen von \texttt{mom\_iq\_c} sind kaum mit
  der AV assoziiert. Das heißt, nutzt man den Teil von
  \texttt{mom\_age\_z}, der nicht mit \texttt{mom\_iq\_z} zusammenhängt,
  um \texttt{kid\_score} vorher zusagen, findet man keinen (\emph{kaum})
  Zusammenhang.
\item
  Unten rechts (D): Die Residuen von \texttt{mom\_age\_c} sind
  \emph{stark} mit der AV assoziiert. Das heißt, nutzt man den Teil von
...
{\centering \includegraphics{./metrische-AV_files/figure-pdf/unnamed-chunk-84-1.pdf}
...
Das Geschlecht (Östrogen) hat einen Einfluss (+) auf Einnahme des
Medikaments und auf Heilung (-). Das Medikament hat einen Einfluss (+)
auf Heilung. Betrachtet man die Gesamt-Daten zur Heilung, so ist der
Effekt von Geschlecht (Östrogen) und Medikament \emph{vermengt}
(konfundiert, confounded).

\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-3-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-5-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-6-1.pdf}
...
nur möglich, wenn das Kausalmodell bekannt ist. Die Daten alleine
reichen nicht.
...
Behandlungsmethode. Die Behandlung hat eien Einfluss auf die Heilung.
Damit gibt es eine Mediation von Größe -\textgreater{} Behandlung
-\textgreater{} Heilung. Darüberhinaus gibt es noch einen Einfluss von
Größe der Nierensteine auf die Heilung.
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-12-1.pdf}
...
\DocumentationTok{\#\# Parameter   |              95\% HDI}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# (Intercept) | [43365.34, 76450.07]}
\DocumentationTok{\#\# bedrooms    | [43050.67, 53304.94]}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# 2.00     |  1.57e+05 | 89278.50 | [{-}11091.33, 3.43e+05]}
\DocumentationTok{\#\# }
...
\DocumentationTok{\#\# bedrooms | Predicted |       SE |               95\% CI}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# 4.00     |  2.53e+05 | 89593.49 | [85741.57, 4.33e+05]}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Variable predicted: price}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-16-1.pdf}
...
\DocumentationTok{\#\# bedrooms | Predicted |      SE |               95\% CI}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# 4.00     |  2.53e+05 | 3066.18 | [2.47e+05, 2.59e+05]}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Variable predicted: price}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# Parameter   |               95\% HDI}
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# (Intercept) | [ 23464.96, 49483.01]}
\DocumentationTok{\#\# bedrooms    | [{-}18959.30, {-}8856.95]}
\DocumentationTok{\#\# livingArea  | [   118.64,   132.31]}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\DocumentationTok{\#\# 4.00     |    1200.00 |  1.30e+05 | 68812.16 | [3965.62, 2.76e+05]}
\DocumentationTok{\#\# }
\DocumentationTok{\#\# Variable predicted: price}
\end{Highlighting}
\end{Shaded}
...
\DocumentationTok{\#\# 2.00     | 2.28e+05 | [2.21e+05, 2.35e+05]}
\DocumentationTok{\#\# 3.00     | 2.14e+05 | [2.11e+05, 2.18e+05]}
\DocumentationTok{\#\# 4.00     | 2.00e+05 | [1.95e+05, 2.05e+05]}
\DocumentationTok{\#\# 5.00     | 1.86e+05 | [1.76e+05, 1.96e+05]}
\DocumentationTok{\#\# 6.00     | 1.71e+05 | [1.57e+05, 1.87e+05]}
\DocumentationTok{\#\# 7.00     | 1.57e+05 | [1.38e+05, 1.78e+05]}
\DocumentationTok{\#\# }
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-21-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-22-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-24-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-25-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-26-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-27-1.pdf}
...
\includegraphics[width=0.5\textwidth,height=\textheight]{./img/correlation_550.png}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-29-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-30-1.pdf}
...
\DocumentationTok{\#\# \# A tibble: 1 x 1}
\DocumentationTok{\#\#   \textasciigrave{}cor(bedrooms, livingArea)\textasciigrave{}}
\DocumentationTok{\#\#                         \textless{}dbl\textgreater{}}
\DocumentationTok{\#\# 1                       0.656}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-32-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-33-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-34-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-35-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-36-1.pdf}
...
\includegraphics[width=1.53in,height=\textheight]{./img/correlation.png}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-39-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-41-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-42-1.pdf}

\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-43-1.pdf}
...
nicht, so entsteht keine Scheinkorrelation zwischen den Ursachen.

\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-45-1.pdf}
...
\hypertarget{durch-kontrolle-entsteht-eine-verzerrung-bei-der-kollision}{%
\subsection{Durch Kontrolle entsteht eine Verzerrung bei der
Kollision}\label{durch-kontrolle-entsteht-eine-verzerrung-bei-der-kollision}}

\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-46-1.pdf}

\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-47-1.pdf}

\begin{itemize}
\item
  Ohne Kontrolle von \texttt{date} entsteht keine Scheinkorrelation
  zwischen \texttt{Looks} und \texttt{Talent}. Der Pfad (``Fluss'') von
  \texttt{Looks} über \texttt{date} nach \texttt{Talent} ist blockiert.
\item
  Kontrolliert man \texttt{date}, so \emph{öffnet} sich der Pfad
  \texttt{Looks}-\textgreater{}\texttt{date}-\textgreater{}
  \texttt{Talent} und die Scheinkorrelation entsteht: Der Pfad ist nicht
  mehr blockiert.
\item
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-48-1.pdf}
...
\FunctionTok{tibble}\NormalTok{(}
  ...
  \AttributeTok{studium =} \FunctionTok{ifelse}\NormalTok{(eignung }\SpecialCharTok{\textgreater{}} \DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{) }\CommentTok{\# nur wer geeignet ist, studiert (in unserem Modell)}
\NormalTok{  )}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-51-1.pdf}
...
Adjustieren) tritt die Scheinkorrelation auf.

Ohne Stratifizierung tritt keine Scheinkorrelation auf

\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-52-1.pdf}

Mit Stratifizierung tritt Scheinkorrelation auf

\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-53-1.pdf}

Wildes Kontrollieren einer Variablen - Aufnehmen in die Regression -
kann genausogut schaden wie nützen.

Nur Kenntnis des DAGs verrät die richtige Entscheidung: ob man eine
Variable kontrolliert oder nicht.
...
kausalen} Effekt von Großeltern auf ihre Enkel.

\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-54-1.pdf}

Aber was ist, wenn wir vielleicht eine \emph{u}nbekannte Variable
übersehen haben? (S. nächste Seite 👻)

(\textbf{kurz\_statistical\_2021f?})
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-56-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-58-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-59-1.pdf}
...
\item
  ...
  (randomsiertes, kontrolliertes) Experiment.
\item
  Wenn wir den Häusern zufällig (randomisiert) eine Anzahl von
  Schlafzimmern (\texttt{b}) zuweisen könnten (unabhängig von ihrer
  Quadratmeterzahl, \texttt{a}), würde sich der Graph so ändern.
\item
  Das Experiment \emph{entfernt} den Einfluss von \texttt{a} auf
  \texttt{b}.
\item
  Wenn wir selber die Werte von \texttt{b} einstellen im Rahmen des
  Experiments, so kann \texttt{a} keine Wirkung auf \texttt{b} haben.
\item
  Damit wird der zweite Pfad, \(b \rightarrow a \rightarrow p\)
...
\begin{itemize}
\item
  Konfundierende Pfade zu blockieren zwischen der UV und der AV nennt
  man auch \emph{die Hintertür schließen} (backdoor criterion).
\item
  Wir wollen die Hintertüre schließen, da wir sonst nicht den wahren,
  kausalen Effekt bestimmen können.
\item
  Zum Glück gibt es neben Experimenten noch andere Wege, die Hintertür
  zu schließen, wie die Konfundierungsvariable \texttt{a} in eine
  Regression mit aufzunehmen.
\item
...
\item
  Sobald Sie \texttt{a} kennen, bringt Ihnen Kenntnis über \texttt{b}
  kein zusätzliches Wissen über \texttt{p}.
\item
  Wissen Sie hingegen nichts über \texttt{a}, lernen Sie bei Kenntnis
  von \texttt{b} auch etwas über \texttt{p}.
\item
  Konditionieren ist wie ``gegeben, dass Sie \texttt{a} schon
  kennen\ldots{}''.
\item
  \(b \perp \!\!\! \perp p \,|\,a\)
\end{itemize}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-64-1.pdf}

\hypertarget{mediation}{%
\subsection{Mediation}\label{mediation}}

\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-65-1.pdf}
...
\item
  ...
  Pfad entlang (in beide Richtungen).
\item
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-66-1.pdf}

Ein \emph{Nachfahre} (descendent) ist eine Variable die von einer
anderen Variable beeinflusst wird. Kontrolliert man einen Nachfahren
\texttt{d}, so kontrolliert man damit zum Teil den Vorfahren (die
Ursache), \texttt{m}. Der Grund ist, dass \texttt{d} Information
beinhaltet über \texttt{m}. Hier wird das Kontrollieren von \texttt{d}
den Pfad von \texttt{x} nach \texttt{y} teilweise öffnen, da \texttt{m}
eine Kollisionsvariable ist.
...
\includegraphics[width=0.5\textwidth,height=\textheight]{./kausal_files/figure-pdf/unnamed-chunk-67-1.pdf}
...
\includegraphics{./kausal_files/figure-pdf/unnamed-chunk-68-1.pdf}
...
\DocumentationTok{\#\#           \textless{}dbl\textgreater{}   \textless{}dbl\textgreater{} \textless{}dbl\textgreater{}}
\DocumentationTok{\#\# 1          28.5 {-}0.0612  2.96}
\DocumentationTok{\#\# 2          30.6 {-}0.0672  4.97}
\DocumentationTok{\#\# 3          27.3 {-}0.0512  3.67}
\DocumentationTok{\#\# 4          31.5 {-}0.0768  4.30}
\DocumentationTok{\#\# 5          29.7 {-}0.0695  4.08}
\DocumentationTok{\#\# 6          30.1 {-}0.0632  3.71}
\end{Highlighting}
\end{Shaded}
...
##   <chr>             <dbl>
## 1 Mazda RX4          17.5
## 2 Mazda RX4 Wag      25.4
## 3 Datsun 710         19.4
## 4 Hornet 4 Drive     20.0
## 5 Hornet Sportabout  18.1
\end{verbatim}
...
\midrule()
\endhead
(Intercept) & 24.70 & (19.03, 29.97) & 100\% & 1.000 & 2395.00 & Normal
(20.09 +- 15.07) \\
hp & -0.04 & (-0.07, -0.01) & 99.72\% & 1.000 & 2457.00 & Normal (0.00
+- 0.22) \\
vs & 13.85 & (4.91, 23.66) & 99.70\% & 1.002 & 1701.00 & Normal (0.00 +-
29.89) \\
hp:vs & -0.11 & (-0.20, -0.03) & 99.42\% & 1.002 & 1814.00 & Normal
(0.00 +- 0.31) \\
\bottomrule()
\end{longtable}
