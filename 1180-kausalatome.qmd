...
Die Sache ist in diesem Fall chancenlos. Wir müssen diesen DAG verloren geben, @mcelreath_statistical_2020, S. 180; ein Gespenster-DAG. 👻 
...
Alle Pfade, die zur UV *hinführen*, sind immer Nicht-Kausal-Pfade. Diese Pfade können offen sein, dann müssen wir sie schließen. Sie können auch geschlossen sein, dann müssen wir nichts tun.
...
Ein gutes Lehrbuch, das auf Kausalinferenz eingeht, ist @huntington-klein_effect_2022. Praktischerweise ist es [öffentlich lesbar](https://theeffectbook.net/ch-CausalPaths.html).
