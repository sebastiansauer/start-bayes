...
#| fig-subcap: 
#|   - Priori-Verteilung zum Mittelwert (mü)
#|   - Priori-Verteilung zur Streuung (sigma)
plots(p1, p2)
```
...
![Gute Arbeit](img/pretty_good.gif)
...
Das Wesentliche: Unser Golem schätzt den Größenmittelwert der Kung auf ca. 155cm bzw. auf einen Bereich von etwa `r parameters(m41)$CI_low` bis `parameters(m41)$CI_high` schätzt.
...
Die Wahrscheinlichkeit, die Hypothese $\mu \gt 165$ auszuschließen ist *nur* dann hoch,
