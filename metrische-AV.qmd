...
Berechnen wir folgendens Modell: `kid_score ~ mom_iq` (`m10.2`).
...
#| fig-cap: "Die Intelligenz eines Kindes als Funktion der Intelligenz der Mutter"
kidiq %>% 
...
```{r fig.asp = .33}
#| fig-cap: "Effekt der UV: Unterschiede zur Referenzgruppe"
...
#| fig-cap: "Modell m10.9; die Farverläufe zeigen der Wert der abhängigen Variablen"
kidiq <-
  kidiq %>%
...
1. [Banova-skalenniveau](https://datenwerk.netlify.app/posts/anova-skalenniveau/anova-skalenniveau.html)
