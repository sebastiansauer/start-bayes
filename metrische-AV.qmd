...
```{r plot-hdi-m101}
#| label: fig-m101hdi
#| fig-cap: "Das 95% HDI zum Effekt des mütterlichen Schulabschlusses"
plot(hdi(m10.1))
```
...
#| fig-cao: "Die Intelligenz eines Kindes als Funktion der Intelligenz der Mutter"
kidiq %>% 
...
#| echo: false
#| label: fig-m104
#| fig-cap: "Wie m10.3, aber mit Interaktionseffekt"
kidiq %>% 
  mutate(mom_hs = factor(mom_hs)) %>%  
  ggplot(aes(x = mom_iq, y = kid_score, color = mom_hs)) +
  geom_point(alpha = .7) +
...
```{r 1010-params-plot}
#| label: fig-m1010hdi
#| fig-cap: "Im Standard wird ein 95%-Intervall gezeigt bzw. berechnet"
plot(hdi(m10.10))
```
