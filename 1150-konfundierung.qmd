...
## Datensatz {#sec-kausal-daten}

In diesem Kapitel nutzen wir den Datensatz [Saratoga County](https://vincentarelbundock.github.io/Rdatasets/csv/mosaicData/SaratogaHouses.csv)^[<https://vincentarelbundock.github.io/Rdatasets/csv/mosaicData/SaratogaHouses.csv>]; s. @tbl-saratoga.
Hier gibt es eine 
...
::: {.callout-note}
Die Folien zu diesem Kapitel finden Sie [hier](slides/1150-konfundierung.html).
:::
:::
...
Importieren Sie den Datensatz `SaratogaHouses`, s. @sec-kausal-daten und @tbl-saratoga.
...
Don 🧑:   "Finden Sie den Wert meiner Immobilie heraus! Die Immobilie muss viel wert sein!"





Angie 👩: "Das finde ich heraus. Ich mach das wissenschaftlich."
...
Angie 👩:   "Hey Don! Mehr Zimmer, mehr Kohle!"
...
Angie 👩: "Jedes Zimmer mehr ist knapp 50 Tausend wert. Dein Haus hat einen Wert von etwa 150 Tausend Dollar, Don."
...
Don 🧑:  "Volltreffer! Jetzt verdien ich 100 Tausend mehr! Ich bin der Größte!"
...
Don 🧑: "Verringert!? Weniger Geld?! Oh nein!"
...
m2a <- stan_glm(price ~ bedrooms + size_group,
                data = d_size_group,
                seed = 42,
                refresh = 0)
...
d_size_group |>
  ...
  labs(caption = "Facetten zeigen Quartile der Variable 'Wohnfläche'")
```

Basierend auf [diesem Quellcode](https://github.com/sebastiansauer/QM2-Folien/blob/main/Themen/children/Hauspreis-stratifizieren.Rmd)^[<https://github.com/sebastiansauer/QM2-Folien/blob/main/Themen/children/Hauspreis-stratifizieren.Rmd>]
...
Don 🧑: "Aber welche und wie viele Prädiktoren soll ich denn jetzt in mein Modell aufnehmen?! Und welches Modell ist jetzt richtig?!"



Angie 👩: "Leider kann die Statistik keine Antwort darauf geben."




Don 🧑:  "Wozu ist sie dann gut?!"
...
führt also dazu, 
dass über diesen Pfad keine Assoziation (z. B. Korrelation) zwischen UV (`bedrooms`) und AV (`price`) mehr vorhanden ist.
...
Don 🧑:   "Ich glaube aber an mein Kausalmodell. Mein Kausalmodell ist das größte! Alle anderen Kausalmodelle sind ein Disaster!"



</br>

Angie 👩:  "Don, nach deinem Kausalmodell müssten `bedrooms` und `livingArea` unkorreliert sein. Sind sie aber nicht. Rechne doch selber die Korrelation aus, Don:


Don 🧑:   "Äh, wie ging das nochmal?"
...
Angie 👩:  "Bitte, gerne hab ich dir geholfen, Don."
...
Viele Menschen denken -- fälschlich -- dass Korrelation Kausation bedeuten müsse. 
Schauen Sie sich dazu einmal das comic 552 con xkcd an.^[<https://xkcd.com/552/> und die Erklärung dazu: <https://www.explainxkcd.com/wiki/index.php/552:_Correlation>]
...
1. [confounder-example](https://sebastiansauer.github.io/datenwerk/posts/confounder-example/index.html)
2. [adjustieren1a](https://sebastiansauer.github.io/datenwerk/posts/adjustieren1a/adjustieren1a.html)

### Computer-Aufgaben

1. [saratoga-cor1](https://sebastiansauer.github.io/datenwerk/posts/saratoga-cor1/saratoga-cor1.html)
